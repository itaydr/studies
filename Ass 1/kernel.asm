...
8010011f:	e8 92 4a 00 00       	call   80104bb6 <sleep>
      goto loop;
...
801003bc:	e8 d2 4a 00 00       	call   80104e93 <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 ce 84 10 80 	movl   $0x801084ce,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec d7 84 10 80 	movl   $0x801084d7,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 ba 49 00 00       	call   80104ef5 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 de 84 10 80 	movl   $0x801084de,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 ed 84 10 80 	movl   $0x801084ed,(%esp)
...
80100592:	e8 ad 49 00 00       	call   80104f44 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 ef 84 10 80 	movl   $0x801084ef,(%esp)
...
801006b2:	e8 fe 4a 00 00       	call   801051b5 <memmove>
    pos -= 80;
...
801006e1:	e8 fc 49 00 00       	call   801050e2 <memset>
  }
...
80100776:	e8 7e 63 00 00       	call   80106af9 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 72 63 00 00       	call   80106af9 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 66 63 00 00       	call   80106af9 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 59 63 00 00       	call   80106af9 <uartputc>
  cgaputc(c);
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 43 45 00 00       	call   80104d32 <procdump>
      break;
...
8010091e:	e8 d2 45 00 00       	call   80104ef5 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 4b 45 00 00       	call   80104e93 <acquire>
  while(n > 0){
...
80100961:	e8 8f 45 00 00       	call   80104ef5 <release>
        ilock(ip);
...
8010098a:	e8 27 42 00 00       	call   80104bb6 <sleep>
...
80100a08:	e8 e8 44 00 00       	call   80104ef5 <release>
  ilock(ip);
...
80100a3e:	e8 50 44 00 00       	call   80104e93 <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 78 44 00 00       	call   80104ef5 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 f3 84 10 	movl   $0x801084f3,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100aa2:	e8 cb 43 00 00       	call   80104e72 <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 fb 84 10 	movl   $0x801084fb,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 80 07 11 80 	movl   $0x80110780,(%esp)
80100ab6:	e8 b7 43 00 00       	call   80104e72 <initlock>
...
80100b78:	0f 85 44 03 00 00    	jne    80100ec2 <exec+0x3c6>
  ...
  if((pgdir = setupkvm()) == 0)
80100b7e:	e8 ba 70 00 00       	call   80107c3d <setupkvm>
...
80100c17:	e8 f3 73 00 00       	call   8010800f <allocuvm>
...
80100c54:	e8 c7 72 00 00       	call   80107f20 <loaduvm>
...
80100cc4:	e8 46 73 00 00       	call   8010800f <allocuvm>
...
80100ce8:	e8 46 75 00 00       	call   80108233 <clearpteu>
  sp = sz;
...
80100d17:	e8 44 46 00 00       	call   80105360 <strlen>
...
80100d35:	e8 26 46 00 00       	call   80105360 <strlen>
...
80100d5f:	e8 94 76 00 00       	call   801083f8 <copyout>
...
80100dff:	e8 f4 75 00 00       	call   801083f8 <copyout>
...
80100e56:	e8 b7 44 00 00       	call   80105312 <safestrcpy>
...
80100ea8:	e8 81 6e 00 00       	call   80107d2e <switchuvm>
  freevm(oldpgdir);
80100ead:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eb0:	89 04 24             	mov    %eax,(%esp)
80100eb3:	e8 ed 72 00 00       	call   801081a5 <freevm>
  return 0;
...
80100eea:	e8 b6 72 00 00       	call   801081a5 <freevm>
  if(ip){
...
80100f12:	c7 44 24 04 01 85 10 	movl   $0x80108501,0x4(%esp)
80100f19:	80 
80100f1a:	c7 04 24 40 08 11 80 	movl   $0x80110840,(%esp)
80100f21:	e8 4c 3f 00 00       	call   80104e72 <initlock>
}
80100f26:	c9                   	leave  
80100f27:	c3                   	ret    
...
80100f35:	e8 59 3f 00 00       	call   80104e93 <acquire>
...
80100f5e:	e8 92 3f 00 00       	call   80104ef5 <release>
      return f;
...
80100f7c:	e8 74 3f 00 00       	call   80104ef5 <release>
  return 0;
...
80100f95:	e8 f9 3e 00 00       	call   80104e93 <acquire>
  if(f->ref < 1)
...
80100fa2:	7f 0c                	jg     80100fb0 <filedup+0x28>
    panic("filedup");
80100fa4:	c7 04 24 08 85 10 80 	movl   $0x80108508,(%esp)
...
80100fc6:	e8 2a 3f 00 00       	call   80104ef5 <release>
  return f;
...
80100fdd:	e8 b1 3e 00 00       	call   80104e93 <acquire>
  if(f->ref < 1)
...
80100fea:	7f 0c                	jg     80100ff8 <fileclose+0x28>
    panic("fileclose");
80100fec:	c7 04 24 10 85 10 80 	movl   $0x80108510,(%esp)
...
80101018:	e8 d8 3e 00 00       	call   80104ef5 <release>
    return;
...
80101062:	e8 8e 3e 00 00       	call   80104ef5 <release>
...
801011a1:	eb 0c                	jmp    801011af <fileread+0xba>
  ...
  panic("fileread");
801011a3:	c7 04 24 1a 85 10 80 	movl   $0x8010851a,(%esp)
...
801012af:	c7 04 24 23 85 10 80 	movl   $0x80108523,(%esp)
...
801012e2:	eb 0c                	jmp    801012f0 <filewrite+0x13f>
  ...
  panic("filewrite");
801012e4:	c7 04 24 33 85 10 80 	movl   $0x80108533,(%esp)
...
8010132c:	e8 84 3e 00 00       	call   801051b5 <memmove>
  brelse(bp);
...
80101372:	e8 6b 3d 00 00       	call   801050e2 <memset>
  log_write(bp);
...
801014d4:	0f 82 e1 fe ff ff    	jb     801013bb <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014da:	c7 04 24 3d 85 10 80 	movl   $0x8010853d,(%esp)
...
80101571:	c7 04 24 53 85 10 80 	movl   $0x80108553,(%esp)
...
801015c5:	c7 44 24 04 66 85 10 	movl   $0x80108566,0x4(%esp)
801015cc:	80 
801015cd:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
801015d4:	e8 99 38 00 00       	call   80104e72 <initlock>
}
801015d9:	c9                   	leave  
801015da:	c3                   	ret    
...
80101656:	e8 87 3a 00 00       	call   801050e2 <memset>
      dip->type = type;
...
801016a6:	0f 82 5a ff ff ff    	jb     80101606 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016ac:	c7 04 24 6d 85 10 80 	movl   $0x8010856d,(%esp)
...
80101753:	e8 5d 3a 00 00       	call   801051b5 <memmove>
  log_write(bp);
...
8010177d:	e8 11 37 00 00       	call   80104e93 <acquire>
...
801017c7:	e8 29 37 00 00       	call   80104ef5 <release>
      return ip;
...
801017fa:	c7 04 24 7f 85 10 80 	movl   $0x8010857f,(%esp)
...
80101838:	e8 b8 36 00 00       	call   80104ef5 <release>
...
8010184f:	e8 3f 36 00 00       	call   80104e93 <acquire>
  ip->ref++;
...
8010186a:	e8 86 36 00 00       	call   80104ef5 <release>
  return ip;
...
80101888:	7f 0c                	jg     80101896 <ilock+0x22>
    panic("ilock");
8010188a:	c7 04 24 8f 85 10 80 	movl   $0x8010858f,(%esp)
80101891:	e8 a7 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101896:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
8010189d:	e8 f1 35 00 00       	call   80104e93 <acquire>
...
801018b2:	e8 ff 32 00 00       	call   80104bb6 <sleep>
...
801018dc:	e8 14 36 00 00       	call   80104ef5 <release>
...
80101987:	e8 29 38 00 00       	call   801051b5 <memmove>
    brelse(bp);
...
801019b2:	75 0c                	jne    801019c0 <ilock+0x14c>
      panic("ilock: no type");
801019b4:	c7 04 24 95 85 10 80 	movl   $0x80108595,(%esp)
...
801019e3:	7f 0c                	jg     801019f1 <iunlock+0x2f>
    panic("iunlock");
801019e5:	c7 04 24 a4 85 10 80 	movl   $0x801085a4,(%esp)
801019ec:	e8 4c eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019f1:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
801019f8:	e8 96 34 00 00       	call   80104e93 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a20:	e8 d0 34 00 00       	call   80104ef5 <release>
}
80101a25:	c9                   	leave  
80101a26:	c3                   	ret    
...
80101a34:	e8 5a 34 00 00       	call   80104e93 <acquire>
...
80101a70:	74 0c                	je     80101a7e <iput+0x57>
      panic("iput busy");
80101a72:	c7 04 24 ac 85 10 80 	movl   $0x801085ac,(%esp)
...
80101a96:	e8 5a 34 00 00       	call   80104ef5 <release>
    itrunc(ip);
...
80101ac1:	e8 cd 33 00 00       	call   80104e93 <acquire>
    ip->flags = 0;
...
80101af1:	e8 ff 33 00 00       	call   80104ef5 <release>
}
80101af6:	c9                   	leave  
80101af7:	c3                   	ret    
...
80101c06:	c7 04 24 b6 85 10 80 	movl   $0x801085b6,(%esp)
...
80101e9e:	e8 12 33 00 00       	call   801051b5 <memmove>
    brelse(bp);
...
80102004:	e8 ac 31 00 00       	call   801051b5 <memmove>
    log_write(bp);
...
80102086:	e8 ce 31 00 00       	call   80105259 <strncmp>
}
8010208b:	c9                   	leave  
8010208c:	c3                   	ret    
...
801020a0:	c7 04 24 c9 85 10 80 	movl   $0x801085c9,(%esp)
...
801020dc:	74 0c                	je     801020ea <dirlookup+0x5d>
      panic("dirlink read");
801020de:	c7 04 24 db 85 10 80 	movl   $0x801085db,(%esp)
...
801021c0:	74 0c                	je     801021ce <dirlink+0x79>
      panic("dirlink read");
801021c2:	c7 04 24 db 85 10 80 	movl   $0x801085db,(%esp)
...
80102208:	e8 a4 30 00 00       	call   801052b1 <strncpy>
  de.inum = inum;
...
80102238:	74 0c                	je     80102246 <dirlink+0xf1>
    panic("dirlink");
8010223a:	c7 04 24 e8 85 10 80 	movl   $0x801085e8,(%esp)
...
801022c1:	e8 ef 2e 00 00       	call   801051b5 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022dc:	e8 d4 2e 00 00       	call   801051b5 <memmove>
    name[len] = 0;
...
80102538:	c7 44 24 04 f0 85 10 	movl   $0x801085f0,0x4(%esp)
8010253f:	80 
80102540:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80102547:	e8 26 29 00 00       	call   80104e72 <initlock>
  picenable(IRQ_IDE);
...
801025e2:	75 0c                	jne    801025f0 <idestart+0x18>
    panic("idestart");
801025e4:	c7 04 24 f4 85 10 80 	movl   $0x801085f4,(%esp)
...
8010270a:	e8 84 27 00 00       	call   80104e93 <acquire>
  if((b = idequeue) == 0){
...
80102724:	e8 cc 27 00 00       	call   80104ef5 <release>
...
801027b9:	e8 37 27 00 00       	call   80104ef5 <release>
}
801027be:	c9                   	leave  
801027bf:	c3                   	ret    
...
801027d2:	c7 04 24 fd 85 10 80 	movl   $0x801085fd,(%esp)
...
801027eb:	c7 04 24 11 86 10 80 	movl   $0x80108611,(%esp)
...
80102876:	e8 3b 23 00 00       	call   80104bb6 <sleep>
...
80102892:	e8 5e 26 00 00       	call   80104ef5 <release>
}
80102897:	c9                   	leave  
80102898:	c3                   	ret    
...
80102922:	c7 04 24 44 86 10 80 	movl   $0x80108644,(%esp)
...
801029e3:	c7 44 24 04 76 86 10 	movl   $0x80108676,0x4(%esp)
801029ea:	80 
801029eb:	c7 04 24 20 22 11 80 	movl   $0x80112220,(%esp)
801029f2:	e8 7b 24 00 00       	call   80104e72 <initlock>
  kmem.use_lock = 0;
...
80102a9d:	76 0c                	jbe    80102aab <kfree+0x39>
    panic("kfree");
80102a9f:	c7 04 24 7b 86 10 80 	movl   $0x8010867b,(%esp)
...
80102ac1:	e8 1c 26 00 00       	call   801050e2 <memset>
...
80102ad6:	e8 b8 23 00 00       	call   80104e93 <acquire>
  r = (struct run*)v;
...
80102b04:	e8 ec 23 00 00       	call   80104ef5 <release>
}
80102b09:	c9                   	leave  
80102b0a:	c3                   	ret    
...
80102b21:	e8 6d 23 00 00       	call   80104e93 <acquire>
  r = kmem.freelist;
...
80102b4e:	e8 a2 23 00 00       	call   80104ef5 <release>
  return (char*)r;
...
80102ef4:	c7 04 24 84 86 10 80 	movl   $0x80108684,(%esp)
...
80103158:	e8 fc 1f 00 00       	call   80105159 <memcmp>
...
8010325a:	c7 44 24 04 b0 86 10 	movl   $0x801086b0,0x4(%esp)
80103261:	80 
80103262:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80103269:	e8 04 1c 00 00       	call   80104e72 <initlock>
  readsb(ROOTDEV, &sb);
...
8010331c:	e8 94 1e 00 00       	call   801051b5 <memmove>
...
8010346e:	e8 20 1a 00 00       	call   80104e93 <acquire>
  while(1){
    if(log.committing){
...
8010348b:	e8 26 17 00 00       	call   80104bb6 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
801034bf:	e8 f2 16 00 00       	call   80104bb6 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
801034da:	e8 16 1a 00 00       	call   80104ef5 <release>
      break;
801034df:	90                   	nop
    }
  }
...
801034f6:	e8 98 19 00 00       	call   80104e93 <acquire>
  log.outstanding -= 1;
...
80103511:	c7 04 24 b4 86 10 80 	movl   $0x801086b4,(%esp)
...
8010354c:	e8 a4 19 00 00       	call   80104ef5 <release>
...
80103563:	e8 2b 19 00 00       	call   80104e93 <acquire>
    log.committing = 0;
...
80103585:	e8 6b 19 00 00       	call   80104ef5 <release>
  }
}
8010358a:	c9                   	leave  
8010358b:	c3                   	ret    
...
801035fd:	e8 b3 1b 00 00       	call   801051b5 <memmove>
...
80103688:	c7 04 24 c3 86 10 80 	movl   $0x801086c3,(%esp)
...
8010369d:	c7 04 24 d9 86 10 80 	movl   $0x801086d9,(%esp)
801036a4:	e8 94 ce ff ff       	call   8010053d <panic>

  acquire(&log.lock);
801036a9:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801036b0:	e8 de 17 00 00       	call   80104e93 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103728:	e8 c8 17 00 00       	call   80104ef5 <release>
}
8010372d:	c9                   	leave  
8010372e:	c3                   	ret    
	...
...
801037b0:	c7 04 24 f4 86 10 80 	movl   $0x801086f4,(%esp)
...
801037cb:	e8 18 32 00 00       	call   801069e8 <uartinit>
  pinit();         // process table
801037d0:	e8 8e 0b 00 00       	call   80104363 <pinit>
  tvinit();        // trap vectors
801037d5:	e8 95 2d 00 00       	call   8010656f <tvinit>
  binit();         // buffer cache
...
801037f7:	e8 b6 2c 00 00       	call   801064b2 <timerinit>
...
80103822:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
80103825:	e8 e7 44 00 00       	call   80107d11 <switchkvm>
  seginit();
8010382a:	e8 6e 3e 00 00       	call   8010769d <seginit>
  lapicinit();
...
8010384f:	c7 04 24 0b 87 10 80 	movl   $0x8010870b,(%esp)
80103856:	e8 46 cb ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
8010385b:	e8 83 2e 00 00       	call   801066e3 <idtinit>
...
8010387b:	e8 8d 11 00 00       	call   80104a0d <scheduler>
...
801038ad:	e8 03 19 00 00       	call   801051b5 <memmove>
...
80103a3b:	00 
80103a3c:	c7 44 24 04 1c 87 10 	movl   $0x8010871c,0x4(%esp)
80103a43:	80 
80103a44:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a47:	89 04 24             	mov    %eax,(%esp)
80103a4a:	e8 0a 17 00 00       	call   80105159 <memcmp>
...
80103b7c:	00 
80103b7d:	c7 44 24 04 21 87 10 	movl   $0x80108721,0x4(%esp)
80103b84:	80 
80103b85:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b88:	89 04 24             	mov    %eax,(%esp)
80103b8b:	e8 c9 15 00 00       	call   80105159 <memcmp>
...
80103c56:	8b 04 85 64 87 10 80 	mov    -0x7fef789c(,%eax,4),%eax
...
80103c8f:	c7 04 24 26 87 10 80 	movl   $0x80108726,(%esp)
...
80103d22:	c7 04 24 44 87 10 80 	movl   $0x80108744,(%esp)
...
80104027:	c7 44 24 04 78 87 10 	movl   $0x80108778,0x4(%esp)
8010402e:	80 
8010402f:	89 04 24             	mov    %eax,(%esp)
80104032:	e8 3b 0e 00 00       	call   80104e72 <initlock>
  (*f0)->type = FD_PIPE;
...
801040df:	e8 af 0d 00 00       	call   80104e93 <acquire>
  if(writable){
...
80104102:	e8 88 0b 00 00       	call   80104c8f <wakeup>
...
80104121:	e8 69 0b 00 00       	call   80104c8f <wakeup>
  }
...
80104146:	e8 aa 0d 00 00       	call   80104ef5 <release>
    kfree((char*)p);
...
8010415e:	e8 92 0d 00 00       	call   80104ef5 <release>
}
80104163:	c9                   	leave  
80104164:	c3                   	ret    
...
80104172:	e8 1c 0d 00 00       	call   80104e93 <acquire>
  for(i = 0; i < n; i++){
...
801041a3:	e8 4d 0d 00 00       	call   80104ef5 <release>
        return -1;
...
801041bd:	e8 cd 0a 00 00       	call   80104c8f <wakeup>
...
801041d5:	e8 dc 09 00 00       	call   80104bb6 <sleep>
...
8010423c:	e8 4e 0a 00 00       	call   80104c8f <wakeup>
  release(&p->lock);
80104241:	8b 45 08             	mov    0x8(%ebp),%eax
80104244:	89 04 24             	mov    %eax,(%esp)
80104247:	e8 a9 0c 00 00       	call   80104ef5 <release>
  return n;
...
80104262:	e8 2c 0c 00 00       	call   80104e93 <acquire>
...
8010427c:	e8 74 0c 00 00       	call   80104ef5 <release>
      return -1;
...
8010429e:	e8 13 09 00 00       	call   80104bb6 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
8010432e:	e8 5c 09 00 00       	call   80104c8f <wakeup>
  release(&p->lock);
80104333:	8b 45 08             	mov    0x8(%ebp),%eax
80104336:	89 04 24             	mov    %eax,(%esp)
80104339:	e8 b7 0b 00 00       	call   80104ef5 <release>
  return i;
...
80104369:	c7 44 24 04 7d 87 10 	movl   $0x8010877d,0x4(%esp)
80104370:	80 
80104371:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104378:	e8 f5 0a 00 00       	call   80104e72 <initlock>
}
8010437d:	c9                   	leave  
8010437e:	c3                   	ret    
...
8010438c:	e8 02 0b 00 00       	call   80104e93 <acquire>
...
801043b8:	e8 38 0b 00 00       	call   80104ef5 <release>
  return 0;
...
801043ec:	e8 04 0b 00 00       	call   80104ef5 <release>
...
80104436:	ba 24 65 10 80       	mov    $0x80106524,%edx
...
80104466:	e8 77 0c 00 00       	call   801050e2 <memset>
  p->context->eip = (uint)forkret;
8010446b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010446e:	8b 40 1c             	mov    0x1c(%eax),%eax
80104471:	ba 8a 4b 10 80       	mov    $0x80104b8a,%edx
...
80104494:	e8 a4 37 00 00       	call   80107c3d <setupkvm>
...
801044a9:	c7 04 24 84 87 10 80 	movl   $0x80108784,(%esp)
...
801044cf:	e8 c1 39 00 00       	call   80107e95 <inituvm>
  p->sz = PGSIZE;
...
801044f6:	e8 e7 0b 00 00       	call   801050e2 <memset>
...
8010456f:	00 
80104570:	c7 44 24 04 9d 87 10 	movl   $0x8010879d,0x4(%esp)
80104577:	80 
80104578:	89 04 24             	mov    %eax,(%esp)
8010457b:	e8 92 0d 00 00       	call   80105312 <safestrcpy>
  p->cwd = namei("/");
80104580:	c7 04 24 a6 87 10 80 	movl   $0x801087a6,(%esp)
...
801045d4:	e8 36 3a 00 00       	call   8010800f <allocuvm>
...
8010460e:	e8 d6 3a 00 00       	call   801080e9 <deallocuvm>
...
80104637:	e8 f2 36 00 00       	call   80107d2e <switchuvm>
  return 0;
...
8010467c:	e8 f8 3b 00 00       	call   80108279 <copyuvm>
...
80104783:	e8 8a 0b 00 00       	call   80105312 <safestrcpy>
...
80104798:	e8 f6 06 00 00       	call   80104e93 <acquire>
  np->state = RUNNABLE;
...
801047ae:	e8 42 07 00 00       	call   80104ef5 <release>
...
801047d2:	75 0c                	jne    801047e0 <exit+0x22>
    panic("init exiting");
801047d4:	c7 04 24 a8 87 10 80 	movl   $0x801087a8,(%esp)
...
80104862:	e8 2c 06 00 00       	call   80104e93 <acquire>
...
80104873:	e8 d9 03 00 00       	call   80104c51 <wakeup1>
...
801048b0:	e8 9c 03 00 00       	call   80104c51 <wakeup1>
...
801048c8:	89 50 7c             	mov    %edx,0x7c(%eax)

  // Jump into the scheduler, never to return.
  proc->state = ZOMBIE;
801048cb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048d1:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
801048d8:	e8 c9 01 00 00       	call   80104aa6 <sched>
  panic("zombie exit");
801048dd:	c7 04 24 b5 87 10 80 	movl   $0x801087b5,(%esp)
...
801048ec:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
801048ef:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
801048f6:	e8 98 05 00 00       	call   80104e93 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
801048fb:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104902:	c7 45 f4 94 29 11 80 	movl   $0x80112994,-0xc(%ebp)
80104909:	e9 af 00 00 00       	jmp    801049bd <wait+0xd4>
      if(p->parent != proc)
...
8010491c:	0f 85 96 00 00 00    	jne    801049b8 <wait+0xcf>
        continue;
      havekids = 1;
80104922:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
80104929:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010492c:	8b 40 0c             	mov    0xc(%eax),%eax
8010492f:	83 f8 05             	cmp    $0x5,%eax
80104932:	0f 85 81 00 00 00    	jne    801049b9 <wait+0xd0>
        // Found one.
        pid = p->pid;
...
80104944:	8b 40 08             	mov    0x8(%eax),%eax
80104947:	89 04 24             	mov    %eax,(%esp)
8010494a:	e8 23 e1 ff ff       	call   80102a72 <kfree>
        p->kstack = 0;
...
80104962:	e8 3e 38 00 00       	call   801081a5 <freevm>
        p->state = UNUSED;
80104967:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010496a:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
80104971:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104974:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
8010497b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010497e:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80104985:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104988:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
8010498c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010498f:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80104996:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
8010499d:	e8 53 05 00 00       	call   80104ef5 <release>
	if (status != NULL) {
801049a2:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801049a6:	74 0b                	je     801049b3 <wait+0xca>
	    *status = p->exitStatus;
801049a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049ab:	8b 50 7c             	mov    0x7c(%eax),%edx
...
801049b1:	89 10                	mov    %edx,(%eax)
        ...
        return pid;
801049b3:	8b 45 ec             	mov    -0x14(%ebp),%eax
801049b6:	eb 53                	jmp    80104a0b <wait+0x122>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801049b8:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049b9:	83 6d f4 80          	subl   $0xffffff80,-0xc(%ebp)
801049bd:	81 7d f4 94 49 11 80 	cmpl   $0x80114994,-0xc(%ebp)
801049c4:	0f 82 44 ff ff ff    	jb     8010490e <wait+0x25>
        return pid;
      }
    }
...
801049ce:	74 0d                	je     801049dd <wait+0xf4>
801049d0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049d6:	8b 40 24             	mov    0x24(%eax),%eax
801049d9:	85 c0                	test   %eax,%eax
801049db:	74 13                	je     801049f0 <wait+0x107>
      release(&ptable.lock);
801049dd:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
801049e4:	e8 0c 05 00 00       	call   80104ef5 <release>
      return -1;
801049e9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801049ee:	eb 1b                	jmp    80104a0b <wait+0x122>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
801049f0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049f6:	c7 44 24 04 60 29 11 	movl   $0x80112960,0x4(%esp)
801049fd:	80 
801049fe:	89 04 24             	mov    %eax,(%esp)
80104a01:	e8 b0 01 00 00       	call   80104bb6 <sleep>
  }
80104a06:	e9 f0 fe ff ff       	jmp    801048fb <wait+0x12>
}
80104a0b:	c9                   	leave  
80104a0c:	c3                   	ret    
...
80104a10:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
80104a13:	e8 45 f9 ff ff       	call   8010435d <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104a18:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104a1f:	e8 6f 04 00 00       	call   80104e93 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a24:	c7 45 f4 94 29 11 80 	movl   $0x80112994,-0xc(%ebp)
80104a2b:	eb 5f                	jmp    80104a8c <scheduler+0x7f>
      if(p->state != RUNNABLE)
80104a2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a30:	8b 40 0c             	mov    0xc(%eax),%eax
80104a33:	83 f8 03             	cmp    $0x3,%eax
80104a36:	75 4f                	jne    80104a87 <scheduler+0x7a>
        continue;
...
80104a3b:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104a41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a44:	89 04 24             	mov    %eax,(%esp)
80104a47:	e8 e2 32 00 00       	call   80107d2e <switchuvm>
      p->state = RUNNING;
...
80104a5f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104a66:	83 c2 04             	add    $0x4,%edx
80104a69:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a6d:	89 14 24             	mov    %edx,(%esp)
80104a70:	e8 13 09 00 00       	call   80105388 <swtch>
      switchkvm();
80104a75:	e8 97 32 00 00       	call   80107d11 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
80104a7a:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104a81:	00 00 00 00 
80104a85:	eb 01                	jmp    80104a88 <scheduler+0x7b>
...
80104a87:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a88:	83 6d f4 80          	subl   $0xffffff80,-0xc(%ebp)
80104a8c:	81 7d f4 94 49 11 80 	cmpl   $0x80114994,-0xc(%ebp)
80104a93:	72 98                	jb     80104a2d <scheduler+0x20>
    ...
    release(&ptable.lock);
80104a95:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104a9c:	e8 54 04 00 00       	call   80104ef5 <release>

  }
80104aa1:	e9 6d ff ff ff       	jmp    80104a13 <scheduler+0x6>
...
80104ab3:	e8 f9 04 00 00       	call   80104fb1 <holding>
80104ab8:	85 c0                	test   %eax,%eax
80104aba:	75 0c                	jne    80104ac8 <sched+0x22>
    panic("sched ptable.lock");
80104abc:	c7 04 24 c1 87 10 80 	movl   $0x801087c1,(%esp)
80104ac3:	e8 75 ba ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
80104ac8:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ace:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104ad4:	83 f8 01             	cmp    $0x1,%eax
80104ad7:	74 0c                	je     80104ae5 <sched+0x3f>
    panic("sched locks");
80104ad9:	c7 04 24 d3 87 10 80 	movl   $0x801087d3,(%esp)
80104ae0:	e8 58 ba ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
80104ae5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104aeb:	8b 40 0c             	mov    0xc(%eax),%eax
80104aee:	83 f8 04             	cmp    $0x4,%eax
80104af1:	75 0c                	jne    80104aff <sched+0x59>
    panic("sched running");
80104af3:	c7 04 24 df 87 10 80 	movl   $0x801087df,(%esp)
80104afa:	e8 3e ba ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
80104aff:	e8 44 f8 ff ff       	call   80104348 <readeflags>
80104b04:	25 00 02 00 00       	and    $0x200,%eax
80104b09:	85 c0                	test   %eax,%eax
80104b0b:	74 0c                	je     80104b19 <sched+0x73>
    panic("sched interruptible");
80104b0d:	c7 04 24 ed 87 10 80 	movl   $0x801087ed,(%esp)
80104b14:	e8 24 ba ff ff       	call   8010053d <panic>
  intena = cpu->intena;
80104b19:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104b1f:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104b25:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104b28:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104b2e:	8b 40 04             	mov    0x4(%eax),%eax
80104b31:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104b38:	83 c2 1c             	add    $0x1c,%edx
80104b3b:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b3f:	89 14 24             	mov    %edx,(%esp)
80104b42:	e8 41 08 00 00       	call   80105388 <swtch>
  cpu->intena = intena;
80104b47:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104b4d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104b50:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104b56:	c9                   	leave  
80104b57:	c3                   	ret    
...
80104b5b:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);  //DOC: yieldlock
80104b5e:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104b65:	e8 29 03 00 00       	call   80104e93 <acquire>
  proc->state = RUNNABLE;
80104b6a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b70:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104b77:	e8 2a ff ff ff       	call   80104aa6 <sched>
  release(&ptable.lock);
80104b7c:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104b83:	e8 6d 03 00 00       	call   80104ef5 <release>
}
80104b88:	c9                   	leave  
80104b89:	c3                   	ret    
...
80104b8d:	83 ec 18             	sub    $0x18,%esp
  static int first = 1;
  // Still holding ptable.lock from scheduler.
  release(&ptable.lock);
80104b90:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104b97:	e8 59 03 00 00       	call   80104ef5 <release>

  if (first) {
80104b9c:	a1 20 b0 10 80       	mov    0x8010b020,%eax
80104ba1:	85 c0                	test   %eax,%eax
80104ba3:	74 0f                	je     80104bb4 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104ba5:	c7 05 20 b0 10 80 00 	movl   $0x0,0x8010b020
80104bac:	00 00 00 
    initlog();
80104baf:	e8 a0 e6 ff ff       	call   80103254 <initlog>
  }
...
80104bb9:	83 ec 18             	sub    $0x18,%esp
  if(proc == 0)
80104bbc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bc2:	85 c0                	test   %eax,%eax
80104bc4:	75 0c                	jne    80104bd2 <sleep+0x1c>
    panic("sleep");
80104bc6:	c7 04 24 01 88 10 80 	movl   $0x80108801,(%esp)
80104bcd:	e8 6b b9 ff ff       	call   8010053d <panic>

  if(lk == 0)
80104bd2:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104bd6:	75 0c                	jne    80104be4 <sleep+0x2e>
    panic("sleep without lk");
80104bd8:	c7 04 24 07 88 10 80 	movl   $0x80108807,(%esp)
80104bdf:	e8 59 b9 ff ff       	call   8010053d <panic>
...
80104be4:	81 7d 0c 60 29 11 80 	cmpl   $0x80112960,0xc(%ebp)
80104beb:	74 17                	je     80104c04 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104bed:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104bf4:	e8 9a 02 00 00       	call   80104e93 <acquire>
    release(lk);
80104bf9:	8b 45 0c             	mov    0xc(%ebp),%eax
80104bfc:	89 04 24             	mov    %eax,(%esp)
80104bff:	e8 f1 02 00 00       	call   80104ef5 <release>
  }
...
80104c0d:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104c10:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104c16:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104c1d:	e8 84 fe ff ff       	call   80104aa6 <sched>

  // Tidy up.
  proc->chan = 0;
80104c22:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104c28:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104c2f:	81 7d 0c 60 29 11 80 	cmpl   $0x80112960,0xc(%ebp)
80104c36:	74 17                	je     80104c4f <sleep+0x99>
    release(&ptable.lock);
80104c38:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104c3f:	e8 b1 02 00 00       	call   80104ef5 <release>
    acquire(lk);
80104c44:	8b 45 0c             	mov    0xc(%ebp),%eax
80104c47:	89 04 24             	mov    %eax,(%esp)
80104c4a:	e8 44 02 00 00       	call   80104e93 <acquire>
  }
}
80104c4f:	c9                   	leave  
80104c50:	c3                   	ret    
...
80104c54:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104c57:	c7 45 fc 94 29 11 80 	movl   $0x80112994,-0x4(%ebp)
80104c5e:	eb 24                	jmp    80104c84 <wakeup1+0x33>
    if(p->state == SLEEPING && p->chan == chan)
80104c60:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104c63:	8b 40 0c             	mov    0xc(%eax),%eax
80104c66:	83 f8 02             	cmp    $0x2,%eax
80104c69:	75 15                	jne    80104c80 <wakeup1+0x2f>
80104c6b:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104c6e:	8b 40 20             	mov    0x20(%eax),%eax
80104c71:	3b 45 08             	cmp    0x8(%ebp),%eax
80104c74:	75 0a                	jne    80104c80 <wakeup1+0x2f>
      p->state = RUNNABLE;
80104c76:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104c79:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104c80:	83 6d fc 80          	subl   $0xffffff80,-0x4(%ebp)
80104c84:	81 7d fc 94 49 11 80 	cmpl   $0x80114994,-0x4(%ebp)
80104c8b:	72 d3                	jb     80104c60 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80104c8d:	c9                   	leave  
...
80104c9c:	e8 f2 01 00 00       	call   80104e93 <acquire>
  wakeup1(chan);
80104ca1:	8b 45 08             	mov    0x8(%ebp),%eax
80104ca4:	89 04 24             	mov    %eax,(%esp)
80104ca7:	e8 a5 ff ff ff       	call   80104c51 <wakeup1>
  release(&ptable.lock);
80104cac:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104cb3:	e8 3d 02 00 00       	call   80104ef5 <release>
}
80104cb8:	c9                   	leave  
80104cb9:	c3                   	ret    
...
80104cc7:	e8 c7 01 00 00       	call   80104e93 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ccc:	c7 45 f4 94 29 11 80 	movl   $0x80112994,-0xc(%ebp)
80104cd3:	eb 41                	jmp    80104d16 <kill+0x5c>
    if(p->pid == pid){
...
80104d06:	e8 ea 01 00 00       	call   80104ef5 <release>
      return 0;
80104d0b:	b8 00 00 00 00       	mov    $0x0,%eax
80104d10:	eb 1e                	jmp    80104d30 <kill+0x76>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d12:	83 6d f4 80          	subl   $0xffffff80,-0xc(%ebp)
80104d16:	81 7d f4 94 49 11 80 	cmpl   $0x80114994,-0xc(%ebp)
80104d1d:	72 b6                	jb     80104cd5 <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80104d1f:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104d26:	e8 ca 01 00 00       	call   80104ef5 <release>
  return -1;
...
80104d35:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d38:	c7 45 f0 94 29 11 80 	movl   $0x80112994,-0x10(%ebp)
80104d3f:	e9 d8 00 00 00       	jmp    80104e1c <procdump+0xea>
    if(p->state == UNUSED)
80104d44:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d47:	8b 40 0c             	mov    0xc(%eax),%eax
80104d4a:	85 c0                	test   %eax,%eax
80104d4c:	0f 84 c5 00 00 00    	je     80104e17 <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104d52:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d55:	8b 40 0c             	mov    0xc(%eax),%eax
80104d58:	83 f8 05             	cmp    $0x5,%eax
80104d5b:	77 23                	ja     80104d80 <procdump+0x4e>
80104d5d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d60:	8b 40 0c             	mov    0xc(%eax),%eax
80104d63:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104d6a:	85 c0                	test   %eax,%eax
80104d6c:	74 12                	je     80104d80 <procdump+0x4e>
      state = states[p->state];
80104d6e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d71:	8b 40 0c             	mov    0xc(%eax),%eax
80104d74:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104d7b:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104d7e:	eb 07                	jmp    80104d87 <procdump+0x55>
    else
      state = "???";
80104d80:	c7 45 ec 18 88 10 80 	movl   $0x80108818,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104d87:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d8a:	8d 50 6c             	lea    0x6c(%eax),%edx
80104d8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d90:	8b 40 10             	mov    0x10(%eax),%eax
80104d93:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104d97:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104d9a:	89 54 24 08          	mov    %edx,0x8(%esp)
80104d9e:	89 44 24 04          	mov    %eax,0x4(%esp)
80104da2:	c7 04 24 1c 88 10 80 	movl   $0x8010881c,(%esp)
80104da9:	e8 f3 b5 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80104dae:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104db1:	8b 40 0c             	mov    0xc(%eax),%eax
80104db4:	83 f8 02             	cmp    $0x2,%eax
80104db7:	75 50                	jne    80104e09 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104db9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104dbc:	8b 40 1c             	mov    0x1c(%eax),%eax
80104dbf:	8b 40 0c             	mov    0xc(%eax),%eax
80104dc2:	83 c0 08             	add    $0x8,%eax
80104dc5:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104dc8:	89 54 24 04          	mov    %edx,0x4(%esp)
80104dcc:	89 04 24             	mov    %eax,(%esp)
80104dcf:	e8 70 01 00 00       	call   80104f44 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104dd4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104ddb:	eb 1b                	jmp    80104df8 <procdump+0xc6>
        cprintf(" %p", pc[i]);
80104ddd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104de0:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104de4:	89 44 24 04          	mov    %eax,0x4(%esp)
80104de8:	c7 04 24 25 88 10 80 	movl   $0x80108825,(%esp)
80104def:	e8 ad b5 ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104df4:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104df8:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104dfc:	7f 0b                	jg     80104e09 <procdump+0xd7>
80104dfe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e01:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104e05:	85 c0                	test   %eax,%eax
80104e07:	75 d4                	jne    80104ddd <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104e09:	c7 04 24 29 88 10 80 	movl   $0x80108829,(%esp)
80104e10:	e8 8c b5 ff ff       	call   801003a1 <cprintf>
80104e15:	eb 01                	jmp    80104e18 <procdump+0xe6>
  char *state;
  uint pc[10];
...
80104e17:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e18:	83 6d f0 80          	subl   $0xffffff80,-0x10(%ebp)
80104e1c:	81 7d f0 94 49 11 80 	cmpl   $0x80114994,-0x10(%ebp)
80104e23:	0f 82 1b ff ff ff    	jb     80104d44 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104e33:	9c                   	pushf  
80104e34:	5b                   	pop    %ebx
80104e35:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
80104e57:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
80104e5a:	8b 4d 08             	mov    0x8(%ebp),%ecx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80104e61:	f0 87 02             	lock xchg %eax,(%edx)
80104e64:	89 c3                	mov    %eax,%ebx
80104e66:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
80104e69:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80104e99:	e8 3d 01 00 00       	call   80104fdb <pushcli>
  if(holding(lk))
80104e9e:	8b 45 08             	mov    0x8(%ebp),%eax
80104ea1:	89 04 24             	mov    %eax,(%esp)
80104ea4:	e8 08 01 00 00       	call   80104fb1 <holding>
80104ea9:	85 c0                	test   %eax,%eax
80104eab:	74 0c                	je     80104eb9 <acquire+0x26>
    panic("acquire");
80104ead:	c7 04 24 55 88 10 80 	movl   $0x80108855,(%esp)
80104eb4:	e8 84 b6 ff ff       	call   8010053d <panic>
...
80104ec8:	e8 80 ff ff ff       	call   80104e4d <xchg>
...
80104f01:	e8 ab 00 00 00       	call   80104fb1 <holding>
80104f06:	85 c0                	test   %eax,%eax
80104f08:	75 0c                	jne    80104f16 <release+0x21>
    panic("release");
80104f0a:	c7 04 24 5d 88 10 80 	movl   $0x8010885d,(%esp)
80104f11:	e8 27 b6 ff ff       	call   8010053d <panic>
...
80104f38:	e8 10 ff ff ff       	call   80104e4d <xchg>

  popcli();
80104f3d:	e8 e1 00 00 00       	call   80105023 <popcli>
}
80104f42:	c9                   	leave  
80104f43:	c3                   	ret    
...
80104f5a:	eb 32                	jmp    80104f8e <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104f5c:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104f60:	74 47                	je     80104fa9 <getcallerpcs+0x65>
80104f62:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104f69:	76 3e                	jbe    80104fa9 <getcallerpcs+0x65>
80104f6b:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104f6f:	74 38                	je     80104fa9 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104f71:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104f74:	c1 e0 02             	shl    $0x2,%eax
80104f77:	03 45 0c             	add    0xc(%ebp),%eax
80104f7a:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104f7d:	8b 52 04             	mov    0x4(%edx),%edx
80104f80:	89 10                	mov    %edx,(%eax)
...
80104f87:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104f8a:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104f8e:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104f92:	7e c8                	jle    80104f5c <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104f94:	eb 13                	jmp    80104fa9 <getcallerpcs+0x65>
    pcs[i] = 0;
80104f96:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104f99:	c1 e0 02             	shl    $0x2,%eax
80104f9c:	03 45 0c             	add    0xc(%ebp),%eax
80104f9f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104fa5:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104fa9:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104fad:	7e e7                	jle    80104f96 <getcallerpcs+0x52>
    pcs[i] = 0;
}
80104faf:	c9                   	leave  
80104fb0:	c3                   	ret    
...
80104fbb:	74 17                	je     80104fd4 <holding+0x23>
80104fbd:	8b 45 08             	mov    0x8(%ebp),%eax
80104fc0:	8b 50 08             	mov    0x8(%eax),%edx
80104fc3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104fc9:	39 c2                	cmp    %eax,%edx
80104fcb:	75 07                	jne    80104fd4 <holding+0x23>
80104fcd:	b8 01 00 00 00       	mov    $0x1,%eax
80104fd2:	eb 05                	jmp    80104fd9 <holding+0x28>
...
80104fde:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80104fe1:	e8 46 fe ff ff       	call   80104e2c <readeflags>
80104fe6:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104fe9:	e8 53 fe ff ff       	call   80104e41 <cli>
  if(cpu->ncli++ == 0)
80104fee:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ff4:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104ffa:	85 d2                	test   %edx,%edx
80104ffc:	0f 94 c1             	sete   %cl
80104fff:	83 c2 01             	add    $0x1,%edx
80105002:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105008:	84 c9                	test   %cl,%cl
8010500a:	74 15                	je     80105021 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
8010500c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105012:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105015:	81 e2 00 02 00 00    	and    $0x200,%edx
8010501b:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105021:	c9                   	leave  
80105022:	c3                   	ret    
...
80105026:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105029:	e8 fe fd ff ff       	call   80104e2c <readeflags>
8010502e:	25 00 02 00 00       	and    $0x200,%eax
80105033:	85 c0                	test   %eax,%eax
80105035:	74 0c                	je     80105043 <popcli+0x20>
    panic("popcli - interruptible");
80105037:	c7 04 24 65 88 10 80 	movl   $0x80108865,(%esp)
8010503e:	e8 fa b4 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
80105043:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105049:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010504f:	83 ea 01             	sub    $0x1,%edx
80105052:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105058:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010505e:	85 c0                	test   %eax,%eax
80105060:	79 0c                	jns    8010506e <popcli+0x4b>
    panic("popcli");
80105062:	c7 04 24 7c 88 10 80 	movl   $0x8010887c,(%esp)
80105069:	e8 cf b4 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
8010506e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105074:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010507a:	85 c0                	test   %eax,%eax
8010507c:	75 15                	jne    80105093 <popcli+0x70>
8010507e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105084:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
8010508a:	85 c0                	test   %eax,%eax
8010508c:	74 05                	je     80105093 <popcli+0x70>
    sti();
8010508e:	e8 b4 fd ff ff       	call   80104e47 <sti>
}
80105093:	c9                   	leave  
80105094:	c3                   	ret    
...
801050ac:	fc                   	cld    
801050ad:	f3 aa                	rep stos %al,%es:(%edi)
...
801050d1:	fc                   	cld    
801050d2:	f3 ab                	rep stos %eax,%es:(%edi)
...
801050eb:	83 e0 03             	and    $0x3,%eax
801050ee:	85 c0                	test   %eax,%eax
801050f0:	75 49                	jne    8010513b <memset+0x59>
801050f2:	8b 45 10             	mov    0x10(%ebp),%eax
801050f5:	83 e0 03             	and    $0x3,%eax
801050f8:	85 c0                	test   %eax,%eax
801050fa:	75 3f                	jne    8010513b <memset+0x59>
    c &= 0xFF;
801050fc:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105103:	8b 45 10             	mov    0x10(%ebp),%eax
80105106:	c1 e8 02             	shr    $0x2,%eax
80105109:	89 c2                	mov    %eax,%edx
8010510b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010510e:	89 c1                	mov    %eax,%ecx
80105110:	c1 e1 18             	shl    $0x18,%ecx
80105113:	8b 45 0c             	mov    0xc(%ebp),%eax
80105116:	c1 e0 10             	shl    $0x10,%eax
80105119:	09 c1                	or     %eax,%ecx
8010511b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010511e:	c1 e0 08             	shl    $0x8,%eax
80105121:	09 c8                	or     %ecx,%eax
80105123:	0b 45 0c             	or     0xc(%ebp),%eax
80105126:	89 54 24 08          	mov    %edx,0x8(%esp)
8010512a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010512e:	8b 45 08             	mov    0x8(%ebp),%eax
80105131:	89 04 24             	mov    %eax,(%esp)
80105134:	e8 84 ff ff ff       	call   801050bd <stosl>
80105139:	eb 19                	jmp    80105154 <memset+0x72>
  } else
    stosb(dst, c, n);
...
8010514f:	e8 44 ff ff ff       	call   80105098 <stosb>
  return dst;
...
80105168:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
8010516b:	eb 32                	jmp    8010519f <memcmp+0x46>
    if(*s1 != *s2)
8010516d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105170:	0f b6 10             	movzbl (%eax),%edx
80105173:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105176:	0f b6 00             	movzbl (%eax),%eax
80105179:	38 c2                	cmp    %al,%dl
8010517b:	74 1a                	je     80105197 <memcmp+0x3e>
      return *s1 - *s2;
8010517d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105180:	0f b6 00             	movzbl (%eax),%eax
80105183:	0f b6 d0             	movzbl %al,%edx
80105186:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105189:	0f b6 00             	movzbl (%eax),%eax
8010518c:	0f b6 c0             	movzbl %al,%eax
8010518f:	89 d1                	mov    %edx,%ecx
80105191:	29 c1                	sub    %eax,%ecx
80105193:	89 c8                	mov    %ecx,%eax
80105195:	eb 1c                	jmp    801051b3 <memcmp+0x5a>
    s1++, s2++;
80105197:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010519b:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  ...
  s2 = v2;
  while(n-- > 0){
8010519f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801051a3:	0f 95 c0             	setne  %al
801051a6:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801051aa:	84 c0                	test   %al,%al
801051ac:	75 bf                	jne    8010516d <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
  ...
  return 0;
801051ae:	b8 00 00 00 00       	mov    $0x0,%eax
}
801051b3:	c9                   	leave  
801051b4:	c3                   	ret    
...
801051ca:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801051cd:	73 54                	jae    80105223 <memmove+0x6e>
801051cf:	8b 45 10             	mov    0x10(%ebp),%eax
801051d2:	8b 55 fc             	mov    -0x4(%ebp),%edx
801051d5:	01 d0                	add    %edx,%eax
801051d7:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801051da:	76 47                	jbe    80105223 <memmove+0x6e>
    s += n;
801051dc:	8b 45 10             	mov    0x10(%ebp),%eax
801051df:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801051e2:	8b 45 10             	mov    0x10(%ebp),%eax
801051e5:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801051e8:	eb 13                	jmp    801051fd <memmove+0x48>
      *--d = *--s;
801051ea:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
801051ee:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
...
80105201:	0f 95 c0             	setne  %al
80105204:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105208:	84 c0                	test   %al,%al
8010520a:	75 de                	jne    801051ea <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
8010520c:	eb 25                	jmp    80105233 <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
80105217:	88 10                	mov    %dl,(%eax)
80105219:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010521d:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105221:	eb 01                	jmp    80105224 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
80105228:	0f 95 c0             	setne  %al
8010522b:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010522f:	84 c0                	test   %al,%al
80105231:	75 db                	jne    8010520e <memmove+0x59>
      *d++ = *s++;
...
80105241:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105252:	e8 5e ff ff ff       	call   801051b5 <memmove>
}
80105257:	c9                   	leave  
80105258:	c3                   	ret    
...
8010525a:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
8010525c:	eb 0c                	jmp    8010526a <strncmp+0x11>
    n--, p++, q++;
8010525e:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105262:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105266:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
80105286:	38 c2                	cmp    %al,%dl
80105288:	74 d4                	je     8010525e <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
8010528a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010528e:	75 07                	jne    80105297 <strncmp+0x3e>
    return 0;
80105290:	b8 00 00 00 00       	mov    $0x0,%eax
80105295:	eb 18                	jmp    801052af <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
80105297:	8b 45 08             	mov    0x8(%ebp),%eax
8010529a:	0f b6 00             	movzbl (%eax),%eax
8010529d:	0f b6 d0             	movzbl %al,%edx
...
801052c2:	0f 9f c0             	setg   %al
801052c5:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801052c9:	84 c0                	test   %al,%al
801052cb:	74 30                	je     801052fd <strncpy+0x4c>
...
801052e0:	0f 95 c0             	setne  %al
801052e3:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801052e7:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
801052eb:	84 c0                	test   %al,%al
801052ed:	75 cf                	jne    801052be <strncpy+0xd>
    ;
  while(n-- > 0)
801052ef:	eb 0c                	jmp    801052fd <strncpy+0x4c>
    *s++ = 0;
801052f1:	8b 45 08             	mov    0x8(%ebp),%eax
801052f4:	c6 00 00             	movb   $0x0,(%eax)
801052f7:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801052fb:	eb 01                	jmp    801052fe <strncpy+0x4d>
  char *os;
...
80105302:	0f 9f c0             	setg   %al
80105305:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105309:	84 c0                	test   %al,%al
8010530b:	75 e4                	jne    801052f1 <strncpy+0x40>
    *s++ = 0;
  return os;
...
80105363:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
80105366:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
8010536d:	eb 04                	jmp    80105373 <strlen+0x13>
8010536f:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105373:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105376:	03 45 08             	add    0x8(%ebp),%eax
80105379:	0f b6 00             	movzbl (%eax),%eax
8010537c:	84 c0                	test   %al,%al
8010537e:	75 ef                	jne    8010536f <strlen+0xf>
    ;
  return n;
...
801053ab:	3b 45 08             	cmp    0x8(%ebp),%eax
801053ae:	76 12                	jbe    801053c2 <fetchint+0x22>
801053b0:	8b 45 08             	mov    0x8(%ebp),%eax
801053b3:	8d 50 04             	lea    0x4(%eax),%edx
801053b6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053bc:	8b 00                	mov    (%eax),%eax
801053be:	39 c2                	cmp    %eax,%edx
801053c0:	76 07                	jbe    801053c9 <fetchint+0x29>
    return -1;
801053c2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053c7:	eb 0f                	jmp    801053d8 <fetchint+0x38>
  *ip = *(int*)(addr);
...
801053e8:	3b 45 08             	cmp    0x8(%ebp),%eax
801053eb:	77 07                	ja     801053f4 <fetchstr+0x1a>
    return -1;
801053ed:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053f2:	eb 48                	jmp    8010543c <fetchstr+0x62>
  *pp = (char*)addr;
...
80105429:	eb 11                	jmp    8010543c <fetchstr+0x62>
...
80105432:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105435:	72 da                	jb     80105411 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
8010544a:	8b 40 18             	mov    0x18(%eax),%eax
8010544d:	8b 50 44             	mov    0x44(%eax),%edx
80105450:	8b 45 08             	mov    0x8(%ebp),%eax
80105453:	c1 e0 02             	shl    $0x2,%eax
80105456:	01 d0                	add    %edx,%eax
80105458:	8d 50 04             	lea    0x4(%eax),%edx
8010545b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010545e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105462:	89 14 24             	mov    %edx,(%esp)
80105465:	e8 36 ff ff ff       	call   801053a0 <fetchint>
}
8010546a:	c9                   	leave  
8010546b:	c3                   	ret    
...
80105515:	8b 40 1c             	mov    0x1c(%eax),%eax
80105518:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
8010551b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010551f:	7e 30                	jle    80105551 <syscall+0x4c>
80105521:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105524:	83 f8 15             	cmp    $0x15,%eax
80105527:	77 28                	ja     80105551 <syscall+0x4c>
80105529:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010552c:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105533:	85 c0                	test   %eax,%eax
80105535:	74 1a                	je     80105551 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105537:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010553d:	8b 58 18             	mov    0x18(%eax),%ebx
80105540:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105543:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
8010554a:	ff d0                	call   *%eax
8010554c:	89 43 1c             	mov    %eax,0x1c(%ebx)
8010554f:	eb 3d                	jmp    8010558e <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105551:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105557:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
80105563:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105566:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010556a:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010556e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105572:	c7 04 24 83 88 10 80 	movl   $0x80108883,(%esp)
80105579:	e8 23 ae ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
8010557e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105584:	8b 40 18             	mov    0x18(%eax),%eax
80105587:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
8010558e:	83 c4 24             	add    $0x24,%esp
80105591:	5b                   	pop    %ebx
80105592:	5d                   	pop    %ebp
80105593:	c3                   	ret    
...
801055a7:	e8 92 fe ff ff       	call   8010543e <argint>
801055ac:	85 c0                	test   %eax,%eax
801055ae:	79 07                	jns    801055b7 <argfd+0x23>
    return -1;
801055b0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055b5:	eb 50                	jmp    80105607 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
801055b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055ba:	85 c0                	test   %eax,%eax
801055bc:	78 21                	js     801055df <argfd+0x4b>
801055be:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055c1:	83 f8 0f             	cmp    $0xf,%eax
801055c4:	7f 19                	jg     801055df <argfd+0x4b>
801055c6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055cc:	8b 55 f0             	mov    -0x10(%ebp),%edx
801055cf:	83 c2 08             	add    $0x8,%edx
801055d2:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801055d6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801055d9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801055dd:	75 07                	jne    801055e6 <argfd+0x52>
    return -1;
801055df:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055e4:	eb 21                	jmp    80105607 <argfd+0x73>
  if(pfd)
801055e6:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801055ea:	74 08                	je     801055f4 <argfd+0x60>
    *pfd = fd;
...
801055f8:	74 08                	je     80105602 <argfd+0x6e>
    *pf = f;
801055fa:	8b 45 10             	mov    0x10(%ebp),%eax
801055fd:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
8010560c:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010560f:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105616:	eb 30                	jmp    80105648 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105618:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010561e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105621:	83 c2 08             	add    $0x8,%edx
80105624:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105628:	85 c0                	test   %eax,%eax
8010562a:	75 18                	jne    80105644 <fdalloc+0x3b>
      proc->ofile[fd] = f;
8010562c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105632:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105635:	8d 4a 08             	lea    0x8(%edx),%ecx
80105638:	8b 55 08             	mov    0x8(%ebp),%edx
8010563b:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
8010563f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105642:	eb 0f                	jmp    80105653 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
...
80105648:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
8010564c:	7e ca                	jle    80105618 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105658:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
  
  if(argfd(0, 0, &f) < 0)
8010565b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010565e:	89 44 24 08          	mov    %eax,0x8(%esp)
80105662:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105669:	00 
8010566a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105671:	e8 1e ff ff ff       	call   80105594 <argfd>
80105676:	85 c0                	test   %eax,%eax
80105678:	79 07                	jns    80105681 <sys_dup+0x2c>
    return -1;
8010567a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010567f:	eb 29                	jmp    801056aa <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105681:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105684:	89 04 24             	mov    %eax,(%esp)
80105687:	e8 7d ff ff ff       	call   80105609 <fdalloc>
8010568c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010568f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105693:	79 07                	jns    8010569c <sys_dup+0x47>
    return -1;
80105695:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010569a:	eb 0e                	jmp    801056aa <sys_dup+0x55>
  filedup(f);
8010569c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010569f:	89 04 24             	mov    %eax,(%esp)
801056a2:	e8 e1 b8 ff ff       	call   80100f88 <filedup>
  return fd;
...
801056c8:	e8 c7 fe ff ff       	call   80105594 <argfd>
801056cd:	85 c0                	test   %eax,%eax
801056cf:	78 35                	js     80105706 <sys_read+0x5a>
801056d1:	8d 45 f0             	lea    -0x10(%ebp),%eax
801056d4:	89 44 24 04          	mov    %eax,0x4(%esp)
801056d8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801056df:	e8 5a fd ff ff       	call   8010543e <argint>
801056e4:	85 c0                	test   %eax,%eax
801056e6:	78 1e                	js     80105706 <sys_read+0x5a>
...
801056fd:	e8 6a fd ff ff       	call   8010546c <argptr>
80105702:	85 c0                	test   %eax,%eax
80105704:	79 07                	jns    8010570d <sys_read+0x61>
    return -1;
80105706:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010570b:	eb 19                	jmp    80105726 <sys_read+0x7a>
...
80105721:	e8 cf b9 ff ff       	call   801010f5 <fileread>
}
80105726:	c9                   	leave  
80105727:	c3                   	ret    
...
80105735:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010573c:	00 
8010573d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105744:	e8 4b fe ff ff       	call   80105594 <argfd>
80105749:	85 c0                	test   %eax,%eax
8010574b:	78 35                	js     80105782 <sys_write+0x5a>
8010574d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105750:	89 44 24 04          	mov    %eax,0x4(%esp)
80105754:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010575b:	e8 de fc ff ff       	call   8010543e <argint>
80105760:	85 c0                	test   %eax,%eax
80105762:	78 1e                	js     80105782 <sys_write+0x5a>
...
80105772:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105779:	e8 ee fc ff ff       	call   8010546c <argptr>
8010577e:	85 c0                	test   %eax,%eax
80105780:	79 07                	jns    80105789 <sys_write+0x61>
    return -1;
80105782:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105787:	eb 19                	jmp    801057a2 <sys_write+0x7a>
  return filewrite(f, p, n);
80105789:	8b 4d f0             	mov    -0x10(%ebp),%ecx
8010578c:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010578f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105792:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105796:	89 54 24 04          	mov    %edx,0x4(%esp)
8010579a:	89 04 24             	mov    %eax,(%esp)
8010579d:	e8 0f ba ff ff       	call   801011b1 <filewrite>
}
801057a2:	c9                   	leave  
801057a3:	c3                   	ret    
...
801057f8:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;
...
80105802:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105809:	00 
8010580a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105811:	e8 7e fd ff ff       	call   80105594 <argfd>
80105816:	85 c0                	test   %eax,%eax
80105818:	78 1f                	js     80105839 <sys_fstat+0x44>
8010581a:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105821:	00 
80105822:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105825:	89 44 24 04          	mov    %eax,0x4(%esp)
80105829:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105830:	e8 37 fc ff ff       	call   8010546c <argptr>
80105835:	85 c0                	test   %eax,%eax
80105837:	79 07                	jns    80105840 <sys_fstat+0x4b>
    return -1;
80105839:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010583e:	eb 12                	jmp    80105852 <sys_fstat+0x5d>
  return filestat(f, st);
80105840:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105843:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105846:	89 54 24 04          	mov    %edx,0x4(%esp)
8010584a:	89 04 24             	mov    %eax,(%esp)
8010584d:	e8 54 b8 ff ff       	call   801010a6 <filestat>
}
80105852:	c9                   	leave  
80105853:	c3                   	ret    
...
80105857:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
8010585a:	8d 45 d8             	lea    -0x28(%ebp),%eax
8010585d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105861:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105868:	e8 61 fc ff ff       	call   801054ce <argstr>
8010586d:	85 c0                	test   %eax,%eax
8010586f:	78 17                	js     80105888 <sys_link+0x34>
80105871:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105874:	89 44 24 04          	mov    %eax,0x4(%esp)
80105878:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010587f:	e8 4a fc ff ff       	call   801054ce <argstr>
80105884:	85 c0                	test   %eax,%eax
80105886:	79 0a                	jns    80105892 <sys_link+0x3e>
    return -1;
80105888:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010588d:	e9 41 01 00 00       	jmp    801059d3 <sys_link+0x17f>

  begin_op();
80105892:	e8 ca db ff ff       	call   80103461 <begin_op>
  if((ip = namei(old)) == 0){
80105897:	8b 45 d8             	mov    -0x28(%ebp),%eax
8010589a:	89 04 24             	mov    %eax,(%esp)
8010589d:	e8 74 cb ff ff       	call   80102416 <namei>
801058a2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801058a5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801058a9:	75 0f                	jne    801058ba <sys_link+0x66>
    end_op();
801058ab:	e8 32 dc ff ff       	call   801034e2 <end_op>
    return -1;
801058b0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058b5:	e9 19 01 00 00       	jmp    801059d3 <sys_link+0x17f>
  }

  ilock(ip);
801058ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058bd:	89 04 24             	mov    %eax,(%esp)
801058c0:	e8 af bf ff ff       	call   80101874 <ilock>
  if(ip->type == T_DIR){
801058c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058c8:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801058cc:	66 83 f8 01          	cmp    $0x1,%ax
801058d0:	75 1a                	jne    801058ec <sys_link+0x98>
    iunlockput(ip);
801058d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058d5:	89 04 24             	mov    %eax,(%esp)
801058d8:	e8 1b c2 ff ff       	call   80101af8 <iunlockput>
    end_op();
801058dd:	e8 00 dc ff ff       	call   801034e2 <end_op>
    return -1;
801058e2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058e7:	e9 e7 00 00 00       	jmp    801059d3 <sys_link+0x17f>
  }

  ip->nlink++;
801058ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058ef:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801058f3:	8d 50 01             	lea    0x1(%eax),%edx
801058f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058f9:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801058fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105900:	89 04 24             	mov    %eax,(%esp)
80105903:	e8 b0 bd ff ff       	call   801016b8 <iupdate>
  iunlock(ip);
80105908:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010590b:	89 04 24             	mov    %eax,(%esp)
8010590e:	e8 af c0 ff ff       	call   801019c2 <iunlock>
...
80105945:	75 20                	jne    80105967 <sys_link+0x113>
...
8010595e:	e8 f2 c7 ff ff       	call   80102155 <dirlink>
80105963:	85 c0                	test   %eax,%eax
80105965:	79 0d                	jns    80105974 <sys_link+0x120>
    iunlockput(dp);
80105967:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010596a:	89 04 24             	mov    %eax,(%esp)
8010596d:	e8 86 c1 ff ff       	call   80101af8 <iunlockput>
    goto bad;
80105972:	eb 23                	jmp    80105997 <sys_link+0x143>
  }
  iunlockput(dp);
80105974:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105977:	89 04 24             	mov    %eax,(%esp)
8010597a:	e8 79 c1 ff ff       	call   80101af8 <iunlockput>
  iput(ip);
8010597f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105982:	89 04 24             	mov    %eax,(%esp)
80105985:	e8 9d c0 ff ff       	call   80101a27 <iput>

  end_op();
8010598a:	e8 53 db ff ff       	call   801034e2 <end_op>

  return 0;
8010598f:	b8 00 00 00 00       	mov    $0x0,%eax
80105994:	eb 3d                	jmp    801059d3 <sys_link+0x17f>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
8010599d:	e8 d2 be ff ff       	call   80101874 <ilock>
  ip->nlink--;
801059a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059a5:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801059a9:	8d 50 ff             	lea    -0x1(%eax),%edx
801059ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059af:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801059b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059b6:	89 04 24             	mov    %eax,(%esp)
801059b9:	e8 fa bc ff ff       	call   801016b8 <iupdate>
  iunlockput(ip);
801059be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059c1:	89 04 24             	mov    %eax,(%esp)
801059c4:	e8 2f c1 ff ff       	call   80101af8 <iunlockput>
  end_op();
801059c9:	e8 14 db ff ff       	call   801034e2 <end_op>
  return -1;
...
801059d8:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801059db:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
801059e2:	eb 4b                	jmp    80105a2f <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801059e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059e7:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801059ee:	00 
801059ef:	89 44 24 08          	mov    %eax,0x8(%esp)
801059f3:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801059f6:	89 44 24 04          	mov    %eax,0x4(%esp)
801059fa:	8b 45 08             	mov    0x8(%ebp),%eax
801059fd:	89 04 24             	mov    %eax,(%esp)
80105a00:	e8 65 c3 ff ff       	call   80101d6a <readi>
80105a05:	83 f8 10             	cmp    $0x10,%eax
80105a08:	74 0c                	je     80105a16 <isdirempty+0x41>
      panic("isdirempty: readi");
80105a0a:	c7 04 24 9f 88 10 80 	movl   $0x8010889f,(%esp)
80105a11:	e8 27 ab ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80105a16:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105a1a:	66 85 c0             	test   %ax,%ax
80105a1d:	74 07                	je     80105a26 <isdirempty+0x51>
      return 0;
80105a1f:	b8 00 00 00 00       	mov    $0x0,%eax
80105a24:	eb 1b                	jmp    80105a41 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105a29:	83 c0 10             	add    $0x10,%eax
...
80105a3a:	72 a8                	jb     801059e4 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
80105a3c:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105a41:	c9                   	leave  
80105a42:	c3                   	ret    
...
80105a46:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105a49:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105a4c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a50:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a57:	e8 72 fa ff ff       	call   801054ce <argstr>
80105a5c:	85 c0                	test   %eax,%eax
80105a5e:	79 0a                	jns    80105a6a <sys_unlink+0x27>
    return -1;
80105a60:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a65:	e9 af 01 00 00       	jmp    80105c19 <sys_unlink+0x1d6>

  begin_op();
80105a6a:	e8 f2 d9 ff ff       	call   80103461 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105a6f:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105a72:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105a75:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a79:	89 04 24             	mov    %eax,(%esp)
80105a7c:	e8 b7 c9 ff ff       	call   80102438 <nameiparent>
80105a81:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a84:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a88:	75 0f                	jne    80105a99 <sys_unlink+0x56>
    end_op();
80105a8a:	e8 53 da ff ff       	call   801034e2 <end_op>
    return -1;
80105a8f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a94:	e9 80 01 00 00       	jmp    80105c19 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105a99:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a9c:	89 04 24             	mov    %eax,(%esp)
80105a9f:	e8 d0 bd ff ff       	call   80101874 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105aa4:	c7 44 24 04 b1 88 10 	movl   $0x801088b1,0x4(%esp)
80105aab:	80 
80105aac:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105aaf:	89 04 24             	mov    %eax,(%esp)
80105ab2:	e8 b4 c5 ff ff       	call   8010206b <namecmp>
80105ab7:	85 c0                	test   %eax,%eax
80105ab9:	0f 84 45 01 00 00    	je     80105c04 <sys_unlink+0x1c1>
80105abf:	c7 44 24 04 b3 88 10 	movl   $0x801088b3,0x4(%esp)
80105ac6:	80 
80105ac7:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105aca:	89 04 24             	mov    %eax,(%esp)
80105acd:	e8 99 c5 ff ff       	call   8010206b <namecmp>
80105ad2:	85 c0                	test   %eax,%eax
80105ad4:	0f 84 2a 01 00 00    	je     80105c04 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105ada:	8d 45 c8             	lea    -0x38(%ebp),%eax
...
80105aee:	e8 9a c5 ff ff       	call   8010208d <dirlookup>
80105af3:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105af6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105afa:	0f 84 03 01 00 00    	je     80105c03 <sys_unlink+0x1c0>
    goto bad;
  ilock(ip);
80105b00:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b03:	89 04 24             	mov    %eax,(%esp)
80105b06:	e8 69 bd ff ff       	call   80101874 <ilock>

  if(ip->nlink < 1)
80105b0b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b0e:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b12:	66 85 c0             	test   %ax,%ax
80105b15:	7f 0c                	jg     80105b23 <sys_unlink+0xe0>
    panic("unlink: nlink < 1");
80105b17:	c7 04 24 b6 88 10 80 	movl   $0x801088b6,(%esp)
80105b1e:	e8 1a aa ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105b23:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b26:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b2a:	66 83 f8 01          	cmp    $0x1,%ax
80105b2e:	75 1f                	jne    80105b4f <sys_unlink+0x10c>
80105b30:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b33:	89 04 24             	mov    %eax,(%esp)
80105b36:	e8 9a fe ff ff       	call   801059d5 <isdirempty>
80105b3b:	85 c0                	test   %eax,%eax
80105b3d:	75 10                	jne    80105b4f <sys_unlink+0x10c>
    iunlockput(ip);
80105b3f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b42:	89 04 24             	mov    %eax,(%esp)
80105b45:	e8 ae bf ff ff       	call   80101af8 <iunlockput>
    goto bad;
80105b4a:	e9 b5 00 00 00       	jmp    80105c04 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105b4f:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105b56:	00 
80105b57:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b5e:	00 
80105b5f:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105b62:	89 04 24             	mov    %eax,(%esp)
80105b65:	e8 78 f5 ff ff       	call   801050e2 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105b6a:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105b6d:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105b74:	00 
80105b75:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b79:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105b7c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b80:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b83:	89 04 24             	mov    %eax,(%esp)
80105b86:	e8 4a c3 ff ff       	call   80101ed5 <writei>
80105b8b:	83 f8 10             	cmp    $0x10,%eax
80105b8e:	74 0c                	je     80105b9c <sys_unlink+0x159>
    panic("unlink: writei");
80105b90:	c7 04 24 c8 88 10 80 	movl   $0x801088c8,(%esp)
80105b97:	e8 a1 a9 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80105b9c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b9f:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105ba3:	66 83 f8 01          	cmp    $0x1,%ax
80105ba7:	75 1c                	jne    80105bc5 <sys_unlink+0x182>
    dp->nlink--;
80105ba9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bac:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105bb0:	8d 50 ff             	lea    -0x1(%eax),%edx
80105bb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bb6:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105bba:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bbd:	89 04 24             	mov    %eax,(%esp)
80105bc0:	e8 f3 ba ff ff       	call   801016b8 <iupdate>
  }
  iunlockput(dp);
80105bc5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bc8:	89 04 24             	mov    %eax,(%esp)
80105bcb:	e8 28 bf ff ff       	call   80101af8 <iunlockput>

  ip->nlink--;
80105bd0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bd3:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105bd7:	8d 50 ff             	lea    -0x1(%eax),%edx
80105bda:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bdd:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105be1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105be4:	89 04 24             	mov    %eax,(%esp)
80105be7:	e8 cc ba ff ff       	call   801016b8 <iupdate>
  iunlockput(ip);
80105bec:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bef:	89 04 24             	mov    %eax,(%esp)
80105bf2:	e8 01 bf ff ff       	call   80101af8 <iunlockput>

  end_op();
80105bf7:	e8 e6 d8 ff ff       	call   801034e2 <end_op>

  return 0;
80105bfc:	b8 00 00 00 00       	mov    $0x0,%eax
80105c01:	eb 16                	jmp    80105c19 <sys_unlink+0x1d6>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80105c0a:	e8 e9 be ff ff       	call   80101af8 <iunlockput>
  end_op();
80105c0f:	e8 ce d8 ff ff       	call   801034e2 <end_op>
  return -1;
80105c14:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80105c19:	c9                   	leave  
80105c1a:	c3                   	ret    
...
80105c1e:	83 ec 48             	sub    $0x48,%esp
80105c21:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105c24:	8b 55 10             	mov    0x10(%ebp),%edx
80105c27:	8b 45 14             	mov    0x14(%ebp),%eax
80105c2a:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105c2e:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105c32:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
80105c99:	e8 d6 bb ff ff       	call   80101874 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105c9e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105ca3:	75 15                	jne    80105cba <create+0x9f>
80105ca5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ca8:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105cac:	66 83 f8 02          	cmp    $0x2,%ax
80105cb0:	75 08                	jne    80105cba <create+0x9f>
      return ip;
80105cb2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cb5:	e9 1f 01 00 00       	jmp    80105dd9 <create+0x1be>
    iunlockput(ip);
80105cba:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cbd:	89 04 24             	mov    %eax,(%esp)
80105cc0:	e8 33 be ff ff       	call   80101af8 <iunlockput>
    return 0;
80105cc5:	b8 00 00 00 00       	mov    $0x0,%eax
80105cca:	e9 0a 01 00 00       	jmp    80105dd9 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105ccf:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105cd3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cd6:	8b 00                	mov    (%eax),%eax
80105cd8:	89 54 24 04          	mov    %edx,0x4(%esp)
80105cdc:	89 04 24             	mov    %eax,(%esp)
80105cdf:	e8 f7 b8 ff ff       	call   801015db <ialloc>
80105ce4:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ce7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ceb:	75 0c                	jne    80105cf9 <create+0xde>
    panic("create: ialloc");
80105ced:	c7 04 24 d7 88 10 80 	movl   $0x801088d7,(%esp)
80105cf4:	e8 44 a8 ff ff       	call   8010053d <panic>

  ilock(ip);
80105cf9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cfc:	89 04 24             	mov    %eax,(%esp)
80105cff:	e8 70 bb ff ff       	call   80101874 <ilock>
  ip->major = major;
80105d04:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d07:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105d0b:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105d0f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d12:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105d16:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105d1a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d1d:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105d23:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d26:	89 04 24             	mov    %eax,(%esp)
80105d29:	e8 8a b9 ff ff       	call   801016b8 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105d2e:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105d33:	75 6a                	jne    80105d9f <create+0x184>
    dp->nlink++;  // for ".."
80105d35:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d38:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105d3c:	8d 50 01             	lea    0x1(%eax),%edx
...
80105d4c:	e8 67 b9 ff ff       	call   801016b8 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105d51:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d54:	8b 40 04             	mov    0x4(%eax),%eax
80105d57:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d5b:	c7 44 24 04 b1 88 10 	movl   $0x801088b1,0x4(%esp)
80105d62:	80 
80105d63:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d66:	89 04 24             	mov    %eax,(%esp)
80105d69:	e8 e7 c3 ff ff       	call   80102155 <dirlink>
80105d6e:	85 c0                	test   %eax,%eax
80105d70:	78 21                	js     80105d93 <create+0x178>
80105d72:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d75:	8b 40 04             	mov    0x4(%eax),%eax
80105d78:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d7c:	c7 44 24 04 b3 88 10 	movl   $0x801088b3,0x4(%esp)
80105d83:	80 
80105d84:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d87:	89 04 24             	mov    %eax,(%esp)
80105d8a:	e8 c6 c3 ff ff       	call   80102155 <dirlink>
80105d8f:	85 c0                	test   %eax,%eax
80105d91:	79 0c                	jns    80105d9f <create+0x184>
      panic("create dots");
80105d93:	c7 04 24 e6 88 10 80 	movl   $0x801088e6,(%esp)
80105d9a:	e8 9e a7 ff ff       	call   8010053d <panic>
  }
...
80105db6:	e8 9a c3 ff ff       	call   80102155 <dirlink>
80105dbb:	85 c0                	test   %eax,%eax
80105dbd:	79 0c                	jns    80105dcb <create+0x1b0>
    panic("create: dirlink");
80105dbf:	c7 04 24 f2 88 10 80 	movl   $0x801088f2,(%esp)
80105dc6:	e8 72 a7 ff ff       	call   8010053d <panic>

  iunlockput(dp);
80105dcb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dce:	89 04 24             	mov    %eax,(%esp)
80105dd1:	e8 22 bd ff ff       	call   80101af8 <iunlockput>
...
80105dde:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105de1:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105de4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105de8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105def:	e8 da f6 ff ff       	call   801054ce <argstr>
80105df4:	85 c0                	test   %eax,%eax
80105df6:	78 17                	js     80105e0f <sys_open+0x34>
80105df8:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105dfb:	89 44 24 04          	mov    %eax,0x4(%esp)
80105dff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105e06:	e8 33 f6 ff ff       	call   8010543e <argint>
80105e0b:	85 c0                	test   %eax,%eax
80105e0d:	79 0a                	jns    80105e19 <sys_open+0x3e>
    return -1;
80105e0f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e14:	e9 5a 01 00 00       	jmp    80105f73 <sys_open+0x198>

  begin_op();
80105e19:	e8 43 d6 ff ff       	call   80103461 <begin_op>

  if(omode & O_CREATE){
80105e1e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e21:	25 00 02 00 00       	and    $0x200,%eax
80105e26:	85 c0                	test   %eax,%eax
80105e28:	74 3b                	je     80105e65 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80105e2a:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e2d:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105e34:	00 
80105e35:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105e3c:	00 
80105e3d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105e44:	00 
80105e45:	89 04 24             	mov    %eax,(%esp)
80105e48:	e8 ce fd ff ff       	call   80105c1b <create>
80105e4d:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80105e50:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e54:	75 6b                	jne    80105ec1 <sys_open+0xe6>
      end_op();
80105e56:	e8 87 d6 ff ff       	call   801034e2 <end_op>
      return -1;
80105e5b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e60:	e9 0e 01 00 00       	jmp    80105f73 <sys_open+0x198>
    }
  } else {
    if((ip = namei(path)) == 0){
80105e65:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e68:	89 04 24             	mov    %eax,(%esp)
80105e6b:	e8 a6 c5 ff ff       	call   80102416 <namei>
80105e70:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e73:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e77:	75 0f                	jne    80105e88 <sys_open+0xad>
      end_op();
80105e79:	e8 64 d6 ff ff       	call   801034e2 <end_op>
      return -1;
80105e7e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e83:	e9 eb 00 00 00       	jmp    80105f73 <sys_open+0x198>
    }
    ilock(ip);
80105e88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e8b:	89 04 24             	mov    %eax,(%esp)
80105e8e:	e8 e1 b9 ff ff       	call   80101874 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105e93:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e96:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e9a:	66 83 f8 01          	cmp    $0x1,%ax
80105e9e:	75 21                	jne    80105ec1 <sys_open+0xe6>
80105ea0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ea3:	85 c0                	test   %eax,%eax
80105ea5:	74 1a                	je     80105ec1 <sys_open+0xe6>
      iunlockput(ip);
80105ea7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105eaa:	89 04 24             	mov    %eax,(%esp)
80105ead:	e8 46 bc ff ff       	call   80101af8 <iunlockput>
      end_op();
80105eb2:	e8 2b d6 ff ff       	call   801034e2 <end_op>
      return -1;
80105eb7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ebc:	e9 b2 00 00 00       	jmp    80105f73 <sys_open+0x198>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105ec1:	e8 62 b0 ff ff       	call   80100f28 <filealloc>
80105ec6:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ec9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ecd:	74 14                	je     80105ee3 <sys_open+0x108>
80105ecf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ed2:	89 04 24             	mov    %eax,(%esp)
80105ed5:	e8 2f f7 ff ff       	call   80105609 <fdalloc>
80105eda:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105edd:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105ee1:	79 28                	jns    80105f0b <sys_open+0x130>
    if(f)
80105ee3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ee7:	74 0b                	je     80105ef4 <sys_open+0x119>
      fileclose(f);
80105ee9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eec:	89 04 24             	mov    %eax,(%esp)
80105eef:	e8 dc b0 ff ff       	call   80100fd0 <fileclose>
    iunlockput(ip);
80105ef4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ef7:	89 04 24             	mov    %eax,(%esp)
80105efa:	e8 f9 bb ff ff       	call   80101af8 <iunlockput>
    end_op();
80105eff:	e8 de d5 ff ff       	call   801034e2 <end_op>
    return -1;
80105f04:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f09:	eb 68                	jmp    80105f73 <sys_open+0x198>
  }
  iunlock(ip);
80105f0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f0e:	89 04 24             	mov    %eax,(%esp)
80105f11:	e8 ac ba ff ff       	call   801019c2 <iunlock>
  end_op();
80105f16:	e8 c7 d5 ff ff       	call   801034e2 <end_op>

  f->type = FD_INODE;
80105f1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f1e:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105f24:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f27:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f2a:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105f2d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f30:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105f37:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f3a:	83 e0 01             	and    $0x1,%eax
80105f3d:	85 c0                	test   %eax,%eax
80105f3f:	0f 94 c2             	sete   %dl
80105f42:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f45:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105f48:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f4b:	83 e0 01             	and    $0x1,%eax
80105f4e:	84 c0                	test   %al,%al
80105f50:	75 0a                	jne    80105f5c <sys_open+0x181>
80105f52:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f55:	83 e0 02             	and    $0x2,%eax
80105f58:	85 c0                	test   %eax,%eax
80105f5a:	74 07                	je     80105f63 <sys_open+0x188>
80105f5c:	b8 01 00 00 00       	mov    $0x1,%eax
80105f61:	eb 05                	jmp    80105f68 <sys_open+0x18d>
80105f63:	b8 00 00 00 00       	mov    $0x0,%eax
80105f68:	89 c2                	mov    %eax,%edx
80105f6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f6d:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80105f70:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80105f73:	c9                   	leave  
80105f74:	c3                   	ret    
...
80105f78:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105f7b:	e8 e1 d4 ff ff       	call   80103461 <begin_op>
...
80105f8e:	e8 3b f5 ff ff       	call   801054ce <argstr>
80105f93:	85 c0                	test   %eax,%eax
80105f95:	78 2c                	js     80105fc3 <sys_mkdir+0x4e>
80105f97:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f9a:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105fa1:	00 
80105fa2:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105fa9:	00 
80105faa:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105fb1:	00 
80105fb2:	89 04 24             	mov    %eax,(%esp)
80105fb5:	e8 61 fc ff ff       	call   80105c1b <create>
80105fba:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105fbd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105fc1:	75 0c                	jne    80105fcf <sys_mkdir+0x5a>
    end_op();
80105fc3:	e8 1a d5 ff ff       	call   801034e2 <end_op>
    return -1;
80105fc8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fcd:	eb 15                	jmp    80105fe4 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80105fcf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fd2:	89 04 24             	mov    %eax,(%esp)
80105fd5:	e8 1e bb ff ff       	call   80101af8 <iunlockput>
  end_op();
80105fda:	e8 03 d5 ff ff       	call   801034e2 <end_op>
  return 0;
...
80105fe9:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_op();
80105fec:	e8 70 d4 ff ff       	call   80103461 <begin_op>
  if((len=argstr(0, &path)) < 0 ||
80105ff1:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105ff4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ff8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105fff:	e8 ca f4 ff ff       	call   801054ce <argstr>
80106004:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106007:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010600b:	78 5e                	js     8010606b <sys_mknod+0x85>
     argint(1, &major) < 0 ||
8010600d:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106010:	89 44 24 04          	mov    %eax,0x4(%esp)
80106014:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010601b:	e8 1e f4 ff ff       	call   8010543e <argint>
  char *path;
  int len;
  int major, minor;
...
80106039:	78 30                	js     8010606b <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
8010603b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010603e:	0f bf c8             	movswl %ax,%ecx
80106041:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106044:	0f bf d0             	movswl %ax,%edx
80106047:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010604a:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010604e:	89 54 24 08          	mov    %edx,0x8(%esp)
80106052:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106059:	00 
8010605a:	89 04 24             	mov    %eax,(%esp)
8010605d:	e8 b9 fb ff ff       	call   80105c1b <create>
80106062:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106065:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106069:	75 0c                	jne    80106077 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
8010606b:	e8 72 d4 ff ff       	call   801034e2 <end_op>
    return -1;
80106070:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106075:	eb 15                	jmp    8010608c <sys_mknod+0xa6>
  }
  iunlockput(ip);
80106077:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010607a:	89 04 24             	mov    %eax,(%esp)
8010607d:	e8 76 ba ff ff       	call   80101af8 <iunlockput>
  end_op();
80106082:	e8 5b d4 ff ff       	call   801034e2 <end_op>
  return 0;
...
80106091:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106094:	e8 c8 d3 ff ff       	call   80103461 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80106099:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010609c:	89 44 24 04          	mov    %eax,0x4(%esp)
801060a0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801060a7:	e8 22 f4 ff ff       	call   801054ce <argstr>
801060ac:	85 c0                	test   %eax,%eax
801060ae:	78 14                	js     801060c4 <sys_chdir+0x36>
801060b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060b3:	89 04 24             	mov    %eax,(%esp)
801060b6:	e8 5b c3 ff ff       	call   80102416 <namei>
801060bb:	89 45 f4             	mov    %eax,-0xc(%ebp)
801060be:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060c2:	75 0c                	jne    801060d0 <sys_chdir+0x42>
    end_op();
801060c4:	e8 19 d4 ff ff       	call   801034e2 <end_op>
    return -1;
801060c9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060ce:	eb 61                	jmp    80106131 <sys_chdir+0xa3>
  }
  ilock(ip);
801060d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060d3:	89 04 24             	mov    %eax,(%esp)
801060d6:	e8 99 b7 ff ff       	call   80101874 <ilock>
  if(ip->type != T_DIR){
801060db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060de:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801060e2:	66 83 f8 01          	cmp    $0x1,%ax
801060e6:	74 17                	je     801060ff <sys_chdir+0x71>
    iunlockput(ip);
801060e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060eb:	89 04 24             	mov    %eax,(%esp)
801060ee:	e8 05 ba ff ff       	call   80101af8 <iunlockput>
    end_op();
801060f3:	e8 ea d3 ff ff       	call   801034e2 <end_op>
    return -1;
801060f8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060fd:	eb 32                	jmp    80106131 <sys_chdir+0xa3>
  }
  iunlock(ip);
801060ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106102:	89 04 24             	mov    %eax,(%esp)
80106105:	e8 b8 b8 ff ff       	call   801019c2 <iunlock>
  iput(proc->cwd);
8010610a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106110:	8b 40 68             	mov    0x68(%eax),%eax
80106113:	89 04 24             	mov    %eax,(%esp)
80106116:	e8 0c b9 ff ff       	call   80101a27 <iput>
  end_op();
8010611b:	e8 c2 d3 ff ff       	call   801034e2 <end_op>
  proc->cwd = ip;
80106120:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
...
8010614a:	e8 7f f3 ff ff       	call   801054ce <argstr>
...
80106190:	e8 4d ef ff ff       	call   801050e2 <memset>
  for(i=0;; i++){
...
801061a9:	e9 95 00 00 00       	jmp    80106243 <sys_exec+0x110>
...
80106204:	e8 f3 a8 ff ff       	call   80100afc <exec>
80106209:	eb 38                	jmp    80106243 <sys_exec+0x110>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
8010620e:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80106215:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010621b:	01 c2                	add    %eax,%edx
8010621d:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106223:	89 54 24 04          	mov    %edx,0x4(%esp)
80106227:	89 04 24             	mov    %eax,(%esp)
8010622a:	e8 ab f1 ff ff       	call   801053da <fetchstr>
8010622f:	85 c0                	test   %eax,%eax
80106231:	79 07                	jns    8010623a <sys_exec+0x107>
      return -1;
80106233:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106238:	eb 09                	jmp    80106243 <sys_exec+0x110>
...
8010623e:	e9 59 ff ff ff       	jmp    8010619c <sys_exec+0x69>
  return exec(path, argv);
}
80106243:	c9                   	leave  
80106244:	c3                   	ret    
...
8010624b:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106252:	00 
80106253:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106256:	89 44 24 04          	mov    %eax,0x4(%esp)
8010625a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106261:	e8 06 f2 ff ff       	call   8010546c <argptr>
80106266:	85 c0                	test   %eax,%eax
80106268:	79 0a                	jns    80106274 <sys_pipe+0x2f>
    return -1;
8010626a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010626f:	e9 9b 00 00 00       	jmp    8010630f <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106274:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106277:	89 44 24 04          	mov    %eax,0x4(%esp)
8010627b:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010627e:	89 04 24             	mov    %eax,(%esp)
80106281:	e8 0a dd ff ff       	call   80103f90 <pipealloc>
80106286:	85 c0                	test   %eax,%eax
80106288:	79 07                	jns    80106291 <sys_pipe+0x4c>
    return -1;
8010628a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010628f:	eb 7e                	jmp    8010630f <sys_pipe+0xca>
  fd0 = -1;
80106291:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106298:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010629b:	89 04 24             	mov    %eax,(%esp)
8010629e:	e8 66 f3 ff ff       	call   80105609 <fdalloc>
801062a3:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062a6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062aa:	78 14                	js     801062c0 <sys_pipe+0x7b>
801062ac:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062af:	89 04 24             	mov    %eax,(%esp)
801062b2:	e8 52 f3 ff ff       	call   80105609 <fdalloc>
801062b7:	89 45 f0             	mov    %eax,-0x10(%ebp)
801062ba:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801062be:	79 37                	jns    801062f7 <sys_pipe+0xb2>
    if(fd0 >= 0)
801062c0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062c4:	78 14                	js     801062da <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
801062c6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801062cc:	8b 55 f4             	mov    -0xc(%ebp),%edx
801062cf:	83 c2 08             	add    $0x8,%edx
801062d2:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801062d9:	00 
    fileclose(rf);
801062da:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062dd:	89 04 24             	mov    %eax,(%esp)
801062e0:	e8 eb ac ff ff       	call   80100fd0 <fileclose>
    fileclose(wf);
801062e5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062e8:	89 04 24             	mov    %eax,(%esp)
801062eb:	e8 e0 ac ff ff       	call   80100fd0 <fileclose>
    return -1;
801062f0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062f5:	eb 18                	jmp    8010630f <sys_pipe+0xca>
  }
  fd[0] = fd0;
...
80106302:	8d 50 04             	lea    0x4(%eax),%edx
80106305:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106308:	89 02                	mov    %eax,(%edx)
  return 0;
8010630a:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010630f:	c9                   	leave  
80106310:	c3                   	ret    
...
80106317:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010631a:	e8 24 e3 ff ff       	call   80104643 <fork>
}
8010631f:	c9                   	leave  
80106320:	c3                   	ret    
...
8010632d:	e8 8c e4 ff ff       	call   801047be <exit>
...
80106346:	e8 9e e5 ff ff       	call   801048e9 <wait>
}
8010634b:	c9                   	leave  
8010634c:	c3                   	ret    
...
80106361:	e8 d8 f0 ff ff       	call   8010543e <argint>
80106366:	85 c0                	test   %eax,%eax
80106368:	79 07                	jns    80106371 <sys_kill+0x24>
    return -1;
8010636a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010636f:	eb 0b                	jmp    8010637c <sys_kill+0x2f>
  return kill(pid);
80106371:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106374:	89 04 24             	mov    %eax,(%esp)
80106377:	e8 3e e9 ff ff       	call   80104cba <kill>
}
8010637c:	c9                   	leave  
8010637d:	c3                   	ret    
...
80106399:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801063a0:	e8 99 f0 ff ff       	call   8010543e <argint>
801063a5:	85 c0                	test   %eax,%eax
801063a7:	79 07                	jns    801063b0 <sys_sbrk+0x24>
    return -1;
801063a9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063ae:	eb 24                	jmp    801063d4 <sys_sbrk+0x48>
  addr = proc->sz;
...
801063c1:	e8 d8 e1 ff ff       	call   8010459e <growproc>
801063c6:	85 c0                	test   %eax,%eax
801063c8:	79 07                	jns    801063d1 <sys_sbrk+0x45>
    return -1;
801063ca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063cf:	eb 03                	jmp    801063d4 <sys_sbrk+0x48>
  return addr;
...
801063d9:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;
  
  if(argint(0, &n) < 0)
801063dc:	8d 45 f0             	lea    -0x10(%ebp),%eax
801063df:	89 44 24 04          	mov    %eax,0x4(%esp)
801063e3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801063ea:	e8 4f f0 ff ff       	call   8010543e <argint>
801063ef:	85 c0                	test   %eax,%eax
801063f1:	79 07                	jns    801063fa <sys_sleep+0x24>
    return -1;
801063f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063f8:	eb 6c                	jmp    80106466 <sys_sleep+0x90>
  acquire(&tickslock);
801063fa:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
80106401:	e8 8d ea ff ff       	call   80104e93 <acquire>
  ticks0 = ticks;
80106406:	a1 e0 51 11 80       	mov    0x801151e0,%eax
8010640b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
8010640e:	eb 34                	jmp    80106444 <sys_sleep+0x6e>
    if(proc->killed){
80106410:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106416:	8b 40 24             	mov    0x24(%eax),%eax
80106419:	85 c0                	test   %eax,%eax
8010641b:	74 13                	je     80106430 <sys_sleep+0x5a>
      release(&tickslock);
8010641d:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
80106424:	e8 cc ea ff ff       	call   80104ef5 <release>
      return -1;
80106429:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010642e:	eb 36                	jmp    80106466 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106430:	c7 44 24 04 a0 49 11 	movl   $0x801149a0,0x4(%esp)
80106437:	80 
80106438:	c7 04 24 e0 51 11 80 	movl   $0x801151e0,(%esp)
8010643f:	e8 72 e7 ff ff       	call   80104bb6 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106444:	a1 e0 51 11 80       	mov    0x801151e0,%eax
80106449:	89 c2                	mov    %eax,%edx
8010644b:	2b 55 f4             	sub    -0xc(%ebp),%edx
8010644e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106451:	39 c2                	cmp    %eax,%edx
80106453:	72 bb                	jb     80106410 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106455:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
8010645c:	e8 94 ea ff ff       	call   80104ef5 <release>
  return 0;
...
8010646b:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
8010646e:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
80106475:	e8 19 ea ff ff       	call   80104e93 <acquire>
  xticks = ticks;
8010647a:	a1 e0 51 11 80       	mov    0x801151e0,%eax
8010647f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106482:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
80106489:	e8 67 ea ff ff       	call   80104ef5 <release>
  return xticks;
...
8010649a:	8b 55 08             	mov    0x8(%ebp),%edx
8010649d:	8b 45 0c             	mov    0xc(%ebp),%eax
801064a0:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801064a4:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801064a7:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801064ab:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801064af:	ee                   	out    %al,(%dx)
}
801064b0:	c9                   	leave  
801064b1:	c3                   	ret    
...
801064b8:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
801064bf:	00 
801064c0:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
801064c7:	e8 c8 ff ff ff       	call   80106494 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
801064cc:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
801064d3:	00 
801064d4:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801064db:	e8 b4 ff ff ff       	call   80106494 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801064e0:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
801064e7:	00 
801064e8:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801064ef:	e8 a0 ff ff ff       	call   80106494 <outb>
  picenable(IRQ_TIMER);
801064f4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801064fb:	e8 19 d9 ff ff       	call   80103e19 <picenable>
}
80106500:	c9                   	leave  
80106501:	c3                   	ret    
	...
...
80106505:	06                   	push   %es
  pushl %fs
80106506:	0f a0                	push   %fs
  pushl %gs
80106508:	0f a8                	push   %gs
  pushal
8010650a:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
8010650b:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010650f:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106511:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106513:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106517:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106519:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
8010651b:	54                   	push   %esp
  call trap
8010651c:	e8 de 01 00 00       	call   801066ff <trap>
  addl $4, %esp
80106521:	83 c4 04             	add    $0x4,%esp
...
80106524:	61                   	popa   
  popl %gs
80106525:	0f a9                	pop    %gs
  popl %fs
80106527:	0f a1                	pop    %fs
  popl %es
80106529:	07                   	pop    %es
  popl %ds
8010652a:	1f                   	pop    %ds
...
80106533:	83 ec 10             	sub    $0x10,%esp
  ...
  pd[0] = size-1;
80106536:	8b 45 0c             	mov    0xc(%ebp),%eax
80106539:	83 e8 01             	sub    $0x1,%eax
8010653c:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106540:	8b 45 08             	mov    0x8(%ebp),%eax
80106543:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106547:	8b 45 08             	mov    0x8(%ebp),%eax
8010654a:	c1 e8 10             	shr    $0x10,%eax
8010654d:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106551:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106554:	0f 01 18             	lidtl  (%eax)
}
80106557:	c9                   	leave  
80106558:	c3                   	ret    
...
80106560:	0f 20 d3             	mov    %cr2,%ebx
80106563:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106566:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
8010657c:	e9 c3 00 00 00       	jmp    80106644 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106581:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106584:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
8010658b:	89 c2                	mov    %eax,%edx
8010658d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106590:	66 89 14 c5 e0 49 11 	mov    %dx,-0x7feeb620(,%eax,8)
80106597:	80 
80106598:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010659b:	66 c7 04 c5 e2 49 11 	movw   $0x8,-0x7feeb61e(,%eax,8)
801065a2:	80 08 00 
801065a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065a8:	0f b6 14 c5 e4 49 11 	movzbl -0x7feeb61c(,%eax,8),%edx
801065af:	80 
801065b0:	83 e2 e0             	and    $0xffffffe0,%edx
801065b3:	88 14 c5 e4 49 11 80 	mov    %dl,-0x7feeb61c(,%eax,8)
801065ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065bd:	0f b6 14 c5 e4 49 11 	movzbl -0x7feeb61c(,%eax,8),%edx
801065c4:	80 
801065c5:	83 e2 1f             	and    $0x1f,%edx
801065c8:	88 14 c5 e4 49 11 80 	mov    %dl,-0x7feeb61c(,%eax,8)
801065cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065d2:	0f b6 14 c5 e5 49 11 	movzbl -0x7feeb61b(,%eax,8),%edx
801065d9:	80 
801065da:	83 e2 f0             	and    $0xfffffff0,%edx
801065dd:	83 ca 0e             	or     $0xe,%edx
801065e0:	88 14 c5 e5 49 11 80 	mov    %dl,-0x7feeb61b(,%eax,8)
801065e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065ea:	0f b6 14 c5 e5 49 11 	movzbl -0x7feeb61b(,%eax,8),%edx
801065f1:	80 
801065f2:	83 e2 ef             	and    $0xffffffef,%edx
801065f5:	88 14 c5 e5 49 11 80 	mov    %dl,-0x7feeb61b(,%eax,8)
801065fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065ff:	0f b6 14 c5 e5 49 11 	movzbl -0x7feeb61b(,%eax,8),%edx
80106606:	80 
80106607:	83 e2 9f             	and    $0xffffff9f,%edx
8010660a:	88 14 c5 e5 49 11 80 	mov    %dl,-0x7feeb61b(,%eax,8)
80106611:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106614:	0f b6 14 c5 e5 49 11 	movzbl -0x7feeb61b(,%eax,8),%edx
8010661b:	80 
8010661c:	83 ca 80             	or     $0xffffff80,%edx
8010661f:	88 14 c5 e5 49 11 80 	mov    %dl,-0x7feeb61b(,%eax,8)
80106626:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106629:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
80106630:	c1 e8 10             	shr    $0x10,%eax
80106633:	89 c2                	mov    %eax,%edx
80106635:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106638:	66 89 14 c5 e6 49 11 	mov    %dx,-0x7feeb61a(,%eax,8)
8010663f:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106640:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106644:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
8010664b:	0f 8e 30 ff ff ff    	jle    80106581 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106651:	a1 98 b1 10 80       	mov    0x8010b198,%eax
80106656:	66 a3 e0 4b 11 80    	mov    %ax,0x80114be0
8010665c:	66 c7 05 e2 4b 11 80 	movw   $0x8,0x80114be2
80106663:	08 00 
80106665:	0f b6 05 e4 4b 11 80 	movzbl 0x80114be4,%eax
8010666c:	83 e0 e0             	and    $0xffffffe0,%eax
8010666f:	a2 e4 4b 11 80       	mov    %al,0x80114be4
80106674:	0f b6 05 e4 4b 11 80 	movzbl 0x80114be4,%eax
8010667b:	83 e0 1f             	and    $0x1f,%eax
8010667e:	a2 e4 4b 11 80       	mov    %al,0x80114be4
80106683:	0f b6 05 e5 4b 11 80 	movzbl 0x80114be5,%eax
8010668a:	83 c8 0f             	or     $0xf,%eax
8010668d:	a2 e5 4b 11 80       	mov    %al,0x80114be5
80106692:	0f b6 05 e5 4b 11 80 	movzbl 0x80114be5,%eax
80106699:	83 e0 ef             	and    $0xffffffef,%eax
8010669c:	a2 e5 4b 11 80       	mov    %al,0x80114be5
801066a1:	0f b6 05 e5 4b 11 80 	movzbl 0x80114be5,%eax
801066a8:	83 c8 60             	or     $0x60,%eax
801066ab:	a2 e5 4b 11 80       	mov    %al,0x80114be5
801066b0:	0f b6 05 e5 4b 11 80 	movzbl 0x80114be5,%eax
801066b7:	83 c8 80             	or     $0xffffff80,%eax
801066ba:	a2 e5 4b 11 80       	mov    %al,0x80114be5
801066bf:	a1 98 b1 10 80       	mov    0x8010b198,%eax
801066c4:	c1 e8 10             	shr    $0x10,%eax
801066c7:	66 a3 e6 4b 11 80    	mov    %ax,0x80114be6
  
  initlock(&tickslock, "time");
801066cd:	c7 44 24 04 04 89 10 	movl   $0x80108904,0x4(%esp)
801066d4:	80 
801066d5:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
801066dc:	e8 91 e7 ff ff       	call   80104e72 <initlock>
}
801066e1:	c9                   	leave  
801066e2:	c3                   	ret    
...
801066e6:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801066e9:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801066f0:	00 
801066f1:	c7 04 24 e0 49 11 80 	movl   $0x801149e0,(%esp)
801066f8:	e8 33 fe ff ff       	call   80106530 <lidt>
}
801066fd:	c9                   	leave  
801066fe:	c3                   	ret    
...
80106702:	57                   	push   %edi
80106703:	56                   	push   %esi
80106704:	53                   	push   %ebx
80106705:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106708:	8b 45 08             	mov    0x8(%ebp),%eax
8010670b:	8b 40 30             	mov    0x30(%eax),%eax
8010670e:	83 f8 40             	cmp    $0x40,%eax
80106711:	75 4c                	jne    8010675f <trap+0x60>
    if(proc->killed)
80106713:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106719:	8b 40 24             	mov    0x24(%eax),%eax
8010671c:	85 c0                	test   %eax,%eax
8010671e:	74 0c                	je     8010672c <trap+0x2d>
      exit(EXIT_STATUS_KILLED);
80106720:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106727:	e8 92 e0 ff ff       	call   801047be <exit>
    proc->tf = tf;
8010672c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106732:	8b 55 08             	mov    0x8(%ebp),%edx
80106735:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106738:	e8 c8 ed ff ff       	call   80105505 <syscall>
    if(proc->killed)
8010673d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106743:	8b 40 24             	mov    0x24(%eax),%eax
80106746:	85 c0                	test   %eax,%eax
80106748:	0f 84 49 02 00 00    	je     80106997 <trap+0x298>
      exit(EXIT_STATUS_KILLED);
8010674e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106755:	e8 64 e0 ff ff       	call   801047be <exit>
    return;
8010675a:	e9 38 02 00 00       	jmp    80106997 <trap+0x298>
  }

  switch(tf->trapno){
8010675f:	8b 45 08             	mov    0x8(%ebp),%eax
80106762:	8b 40 30             	mov    0x30(%eax),%eax
80106765:	83 e8 20             	sub    $0x20,%eax
80106768:	83 f8 1f             	cmp    $0x1f,%eax
8010676b:	0f 87 bc 00 00 00    	ja     8010682d <trap+0x12e>
80106771:	8b 04 85 ac 89 10 80 	mov    -0x7fef7654(,%eax,4),%eax
80106778:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
8010677a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106780:	0f b6 00             	movzbl (%eax),%eax
80106783:	84 c0                	test   %al,%al
80106785:	75 31                	jne    801067b8 <trap+0xb9>
      acquire(&tickslock);
80106787:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
8010678e:	e8 00 e7 ff ff       	call   80104e93 <acquire>
      ticks++;
80106793:	a1 e0 51 11 80       	mov    0x801151e0,%eax
80106798:	83 c0 01             	add    $0x1,%eax
8010679b:	a3 e0 51 11 80       	mov    %eax,0x801151e0
      wakeup(&ticks);
801067a0:	c7 04 24 e0 51 11 80 	movl   $0x801151e0,(%esp)
801067a7:	e8 e3 e4 ff ff       	call   80104c8f <wakeup>
      release(&tickslock);
801067ac:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
801067b3:	e8 3d e7 ff ff       	call   80104ef5 <release>
    }
    lapiceoi();
801067b8:	e8 62 c7 ff ff       	call   80102f1f <lapiceoi>
    break;
801067bd:	e9 41 01 00 00       	jmp    80106903 <trap+0x204>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801067c2:	e8 36 bf ff ff       	call   801026fd <ideintr>
    lapiceoi();
801067c7:	e8 53 c7 ff ff       	call   80102f1f <lapiceoi>
    break;
801067cc:	e9 32 01 00 00       	jmp    80106903 <trap+0x204>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801067d1:	e8 fd c4 ff ff       	call   80102cd3 <kbdintr>
    lapiceoi();
801067d6:	e8 44 c7 ff ff       	call   80102f1f <lapiceoi>
    break;
801067db:	e9 23 01 00 00       	jmp    80106903 <trap+0x204>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801067e0:	e8 b7 03 00 00       	call   80106b9c <uartintr>
    lapiceoi();
801067e5:	e8 35 c7 ff ff       	call   80102f1f <lapiceoi>
    break;
801067ea:	e9 14 01 00 00       	jmp    80106903 <trap+0x204>
  case T_IRQ0 + 7:
...
801067ef:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801067f2:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
801067f5:	8b 45 08             	mov    0x8(%ebp),%eax
801067f8:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801067fc:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
801067ff:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106805:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106808:	0f b6 c0             	movzbl %al,%eax
8010680b:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010680f:	89 54 24 08          	mov    %edx,0x8(%esp)
80106813:	89 44 24 04          	mov    %eax,0x4(%esp)
80106817:	c7 04 24 0c 89 10 80 	movl   $0x8010890c,(%esp)
8010681e:	e8 7e 9b ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106823:	e8 f7 c6 ff ff       	call   80102f1f <lapiceoi>
    break;
80106828:	e9 d6 00 00 00       	jmp    80106903 <trap+0x204>
...
80106835:	74 11                	je     80106848 <trap+0x149>
80106837:	8b 45 08             	mov    0x8(%ebp),%eax
8010683a:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
8010683e:	0f b7 c0             	movzwl %ax,%eax
80106841:	83 e0 03             	and    $0x3,%eax
80106844:	85 c0                	test   %eax,%eax
80106846:	75 46                	jne    8010688e <trap+0x18f>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106848:	e8 0c fd ff ff       	call   80106559 <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
8010684d:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106850:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106853:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010685a:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010685d:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106860:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106863:	8b 52 30             	mov    0x30(%edx),%edx
80106866:	89 44 24 10          	mov    %eax,0x10(%esp)
8010686a:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010686e:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106872:	89 54 24 04          	mov    %edx,0x4(%esp)
80106876:	c7 04 24 30 89 10 80 	movl   $0x80108930,(%esp)
8010687d:	e8 1f 9b ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106882:	c7 04 24 62 89 10 80 	movl   $0x80108962,(%esp)
80106889:	e8 af 9c ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010688e:	e8 c6 fc ff ff       	call   80106559 <rcr2>
80106893:	89 c2                	mov    %eax,%edx
...
80106895:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106898:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
...
801068a1:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801068a4:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801068a7:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801068aa:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801068ad:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801068b0:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801068b3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068b9:	83 c0 6c             	add    $0x6c,%eax
801068bc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068bf:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801068c5:	8b 40 10             	mov    0x10(%eax),%eax
801068c8:	89 54 24 1c          	mov    %edx,0x1c(%esp)
801068cc:	89 7c 24 18          	mov    %edi,0x18(%esp)
801068d0:	89 74 24 14          	mov    %esi,0x14(%esp)
801068d4:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801068d8:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801068dc:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801068df:	89 54 24 08          	mov    %edx,0x8(%esp)
801068e3:	89 44 24 04          	mov    %eax,0x4(%esp)
801068e7:	c7 04 24 68 89 10 80 	movl   $0x80108968,(%esp)
801068ee:	e8 ae 9a ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
801068f3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068f9:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106900:	eb 01                	jmp    80106903 <trap+0x204>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106927:	83 f8 03             	cmp    $0x3,%eax
8010692a:	75 0c                	jne    80106938 <trap+0x239>
    exit(EXIT_STATUS_KILLED);
8010692c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106933:	e8 86 de ff ff       	call   801047be <exit>
...
80106940:	74 1e                	je     80106960 <trap+0x261>
80106942:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106948:	8b 40 0c             	mov    0xc(%eax),%eax
8010694b:	83 f8 04             	cmp    $0x4,%eax
8010694e:	75 10                	jne    80106960 <trap+0x261>
80106950:	8b 45 08             	mov    0x8(%ebp),%eax
80106953:	8b 40 30             	mov    0x30(%eax),%eax
80106956:	83 f8 20             	cmp    $0x20,%eax
80106959:	75 05                	jne    80106960 <trap+0x261>
    yield();
8010695b:	e8 f8 e1 ff ff       	call   80104b58 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106960:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106966:	85 c0                	test   %eax,%eax
80106968:	74 2e                	je     80106998 <trap+0x299>
8010696a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106970:	8b 40 24             	mov    0x24(%eax),%eax
80106973:	85 c0                	test   %eax,%eax
80106975:	74 21                	je     80106998 <trap+0x299>
80106977:	8b 45 08             	mov    0x8(%ebp),%eax
8010697a:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
8010697e:	0f b7 c0             	movzwl %ax,%eax
80106981:	83 e0 03             	and    $0x3,%eax
80106984:	83 f8 03             	cmp    $0x3,%eax
80106987:	75 0f                	jne    80106998 <trap+0x299>
    exit(EXIT_STATUS_KILLED);
80106989:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106990:	e8 29 de ff ff       	call   801047be <exit>
80106995:	eb 01                	jmp    80106998 <trap+0x299>
      exit(EXIT_STATUS_KILLED);
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80106998:	83 c4 3c             	add    $0x3c,%esp
8010699b:	5b                   	pop    %ebx
8010699c:	5e                   	pop    %esi
8010699d:	5f                   	pop    %edi
8010699e:	5d                   	pop    %ebp
...
801069a4:	83 ec 14             	sub    $0x14,%esp
801069a7:	8b 45 08             	mov    0x8(%ebp),%eax
801069aa:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801069ae:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
801069b2:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
801069b6:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
801069ba:	ec                   	in     (%dx),%al
801069bb:	89 c3                	mov    %eax,%ebx
801069bd:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
801069c0:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
801069c4:	83 c4 14             	add    $0x14,%esp
801069c7:	5b                   	pop    %ebx
801069c8:	5d                   	pop    %ebp
801069c9:	c3                   	ret    
...
801069d6:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801069da:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801069dd:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801069e1:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801069e5:	ee                   	out    %al,(%dx)
}
801069e6:	c9                   	leave  
801069e7:	c3                   	ret    
...
801069eb:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
801069ee:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069f5:	00 
801069f6:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801069fd:	e8 c8 ff ff ff       	call   801069ca <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106a02:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106a09:	00 
80106a0a:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106a11:	e8 b4 ff ff ff       	call   801069ca <outb>
  outb(COM1+0, 115200/9600);
80106a16:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106a1d:	00 
80106a1e:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106a25:	e8 a0 ff ff ff       	call   801069ca <outb>
  outb(COM1+1, 0);
80106a2a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a31:	00 
80106a32:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106a39:	e8 8c ff ff ff       	call   801069ca <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106a3e:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106a45:	00 
80106a46:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106a4d:	e8 78 ff ff ff       	call   801069ca <outb>
  outb(COM1+4, 0);
80106a52:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a59:	00 
80106a5a:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106a61:	e8 64 ff ff ff       	call   801069ca <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106a66:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106a6d:	00 
80106a6e:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106a75:	e8 50 ff ff ff       	call   801069ca <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106a7a:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106a81:	e8 1a ff ff ff       	call   801069a0 <inb>
80106a86:	3c ff                	cmp    $0xff,%al
80106a88:	74 6c                	je     80106af6 <uartinit+0x10e>
    return;
  uart = 1;
80106a8a:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
80106a91:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106a94:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106a9b:	e8 00 ff ff ff       	call   801069a0 <inb>
  inb(COM1+0);
80106aa0:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106aa7:	e8 f4 fe ff ff       	call   801069a0 <inb>
  picenable(IRQ_COM1);
80106aac:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106ab3:	e8 61 d3 ff ff       	call   80103e19 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106ab8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106abf:	00 
80106ac0:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106ac7:	e8 b6 be ff ff       	call   80102982 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106acc:	c7 45 f4 2c 8a 10 80 	movl   $0x80108a2c,-0xc(%ebp)
80106ad3:	eb 15                	jmp    80106aea <uartinit+0x102>
    uartputc(*p);
80106ad5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ad8:	0f b6 00             	movzbl (%eax),%eax
80106adb:	0f be c0             	movsbl %al,%eax
80106ade:	89 04 24             	mov    %eax,(%esp)
80106ae1:	e8 13 00 00 00       	call   80106af9 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106ae6:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106aea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106aed:	0f b6 00             	movzbl (%eax),%eax
80106af0:	84 c0                	test   %al,%al
80106af2:	75 e1                	jne    80106ad5 <uartinit+0xed>
80106af4:	eb 01                	jmp    80106af7 <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
80106afc:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106aff:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106b04:	85 c0                	test   %eax,%eax
80106b06:	74 4d                	je     80106b55 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106b08:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106b0f:	eb 10                	jmp    80106b21 <uartputc+0x28>
    microdelay(10);
80106b11:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106b18:	e8 27 c4 ff ff       	call   80102f44 <microdelay>
{
  int i;
...
80106b21:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106b25:	7f 16                	jg     80106b3d <uartputc+0x44>
80106b27:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b2e:	e8 6d fe ff ff       	call   801069a0 <inb>
80106b33:	0f b6 c0             	movzbl %al,%eax
80106b36:	83 e0 20             	and    $0x20,%eax
80106b39:	85 c0                	test   %eax,%eax
80106b3b:	74 d4                	je     80106b11 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
80106b3d:	8b 45 08             	mov    0x8(%ebp),%eax
80106b40:	0f b6 c0             	movzbl %al,%eax
80106b43:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b47:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b4e:	e8 77 fe ff ff       	call   801069ca <outb>
80106b53:	eb 01                	jmp    80106b56 <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
80106b5b:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106b5e:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106b63:	85 c0                	test   %eax,%eax
80106b65:	75 07                	jne    80106b6e <uartgetc+0x16>
    return -1;
80106b67:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b6c:	eb 2c                	jmp    80106b9a <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106b6e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b75:	e8 26 fe ff ff       	call   801069a0 <inb>
80106b7a:	0f b6 c0             	movzbl %al,%eax
80106b7d:	83 e0 01             	and    $0x1,%eax
80106b80:	85 c0                	test   %eax,%eax
80106b82:	75 07                	jne    80106b8b <uartgetc+0x33>
    return -1;
80106b84:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b89:	eb 0f                	jmp    80106b9a <uartgetc+0x42>
  return inb(COM1+0);
80106b8b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b92:	e8 09 fe ff ff       	call   801069a0 <inb>
80106b97:	0f b6 c0             	movzbl %al,%eax
}
80106b9a:	c9                   	leave  
80106b9b:	c3                   	ret    
...
80106ba2:	c7 04 24 58 6b 10 80 	movl   $0x80106b58,(%esp)
80106ba9:	e8 ff 9b ff ff       	call   801007ad <consoleintr>
}
80106bae:	c9                   	leave  
80106baf:	c3                   	ret    
...
80106bb2:	6a 00                	push   $0x0
  jmp alltraps
80106bb4:	e9 4b f9 ff ff       	jmp    80106504 <alltraps>
...
80106bb9:	6a 00                	push   $0x0
  pushl $1
80106bbb:	6a 01                	push   $0x1
  jmp alltraps
80106bbd:	e9 42 f9 ff ff       	jmp    80106504 <alltraps>
...
80106bc2:	6a 00                	push   $0x0
  pushl $2
80106bc4:	6a 02                	push   $0x2
  jmp alltraps
80106bc6:	e9 39 f9 ff ff       	jmp    80106504 <alltraps>
...
80106bcd:	6a 03                	push   $0x3
  jmp alltraps
80106bcf:	e9 30 f9 ff ff       	jmp    80106504 <alltraps>
...
80106bd6:	6a 04                	push   $0x4
  jmp alltraps
80106bd8:	e9 27 f9 ff ff       	jmp    80106504 <alltraps>
...
80106bdd:	6a 00                	push   $0x0
  pushl $5
80106bdf:	6a 05                	push   $0x5
  jmp alltraps
80106be1:	e9 1e f9 ff ff       	jmp    80106504 <alltraps>
...
80106be8:	6a 06                	push   $0x6
  jmp alltraps
80106bea:	e9 15 f9 ff ff       	jmp    80106504 <alltraps>
...
80106bef:	6a 00                	push   $0x0
  pushl $7
80106bf1:	6a 07                	push   $0x7
  jmp alltraps
80106bf3:	e9 0c f9 ff ff       	jmp    80106504 <alltraps>

80106bf8 <vector8>:
.globl vector8
vector8:
  pushl $8
80106bf8:	6a 08                	push   $0x8
  jmp alltraps
80106bfa:	e9 05 f9 ff ff       	jmp    80106504 <alltraps>
...
80106bff:	6a 00                	push   $0x0
  pushl $9
80106c01:	6a 09                	push   $0x9
  jmp alltraps
80106c03:	e9 fc f8 ff ff       	jmp    80106504 <alltraps>

80106c08 <vector10>:
.globl vector10
vector10:
  pushl $10
80106c08:	6a 0a                	push   $0xa
  jmp alltraps
80106c0a:	e9 f5 f8 ff ff       	jmp    80106504 <alltraps>

80106c0f <vector11>:
.globl vector11
vector11:
  pushl $11
80106c0f:	6a 0b                	push   $0xb
  jmp alltraps
80106c11:	e9 ee f8 ff ff       	jmp    80106504 <alltraps>

80106c16 <vector12>:
.globl vector12
vector12:
  pushl $12
80106c16:	6a 0c                	push   $0xc
  jmp alltraps
80106c18:	e9 e7 f8 ff ff       	jmp    80106504 <alltraps>

80106c1d <vector13>:
.globl vector13
vector13:
  pushl $13
80106c1d:	6a 0d                	push   $0xd
  jmp alltraps
80106c1f:	e9 e0 f8 ff ff       	jmp    80106504 <alltraps>

80106c24 <vector14>:
.globl vector14
vector14:
  pushl $14
80106c24:	6a 0e                	push   $0xe
  jmp alltraps
80106c26:	e9 d9 f8 ff ff       	jmp    80106504 <alltraps>
...
80106c2b:	6a 00                	push   $0x0
  pushl $15
80106c2d:	6a 0f                	push   $0xf
  jmp alltraps
80106c2f:	e9 d0 f8 ff ff       	jmp    80106504 <alltraps>
...
80106c34:	6a 00                	push   $0x0
  pushl $16
80106c36:	6a 10                	push   $0x10
  jmp alltraps
80106c38:	e9 c7 f8 ff ff       	jmp    80106504 <alltraps>

80106c3d <vector17>:
.globl vector17
vector17:
  pushl $17
80106c3d:	6a 11                	push   $0x11
  jmp alltraps
80106c3f:	e9 c0 f8 ff ff       	jmp    80106504 <alltraps>
...
80106c44:	6a 00                	push   $0x0
  pushl $18
80106c46:	6a 12                	push   $0x12
  jmp alltraps
80106c48:	e9 b7 f8 ff ff       	jmp    80106504 <alltraps>
...
80106c4d:	6a 00                	push   $0x0
  pushl $19
80106c4f:	6a 13                	push   $0x13
  jmp alltraps
80106c51:	e9 ae f8 ff ff       	jmp    80106504 <alltraps>
...
80106c56:	6a 00                	push   $0x0
  pushl $20
80106c58:	6a 14                	push   $0x14
  jmp alltraps
80106c5a:	e9 a5 f8 ff ff       	jmp    80106504 <alltraps>
...
80106c5f:	6a 00                	push   $0x0
  pushl $21
80106c61:	6a 15                	push   $0x15
  jmp alltraps
80106c63:	e9 9c f8 ff ff       	jmp    80106504 <alltraps>
...
80106c68:	6a 00                	push   $0x0
  pushl $22
80106c6a:	6a 16                	push   $0x16
  jmp alltraps
80106c6c:	e9 93 f8 ff ff       	jmp    80106504 <alltraps>
...
80106c71:	6a 00                	push   $0x0
  pushl $23
80106c73:	6a 17                	push   $0x17
  jmp alltraps
80106c75:	e9 8a f8 ff ff       	jmp    80106504 <alltraps>
...
80106c7a:	6a 00                	push   $0x0
  pushl $24
80106c7c:	6a 18                	push   $0x18
  jmp alltraps
80106c7e:	e9 81 f8 ff ff       	jmp    80106504 <alltraps>
...
80106c83:	6a 00                	push   $0x0
  pushl $25
80106c85:	6a 19                	push   $0x19
  jmp alltraps
80106c87:	e9 78 f8 ff ff       	jmp    80106504 <alltraps>
...
80106c8c:	6a 00                	push   $0x0
  pushl $26
80106c8e:	6a 1a                	push   $0x1a
  jmp alltraps
80106c90:	e9 6f f8 ff ff       	jmp    80106504 <alltraps>
...
80106c95:	6a 00                	push   $0x0
  pushl $27
80106c97:	6a 1b                	push   $0x1b
  jmp alltraps
80106c99:	e9 66 f8 ff ff       	jmp    80106504 <alltraps>
...
80106c9e:	6a 00                	push   $0x0
  pushl $28
80106ca0:	6a 1c                	push   $0x1c
  jmp alltraps
80106ca2:	e9 5d f8 ff ff       	jmp    80106504 <alltraps>
...
80106ca7:	6a 00                	push   $0x0
  pushl $29
80106ca9:	6a 1d                	push   $0x1d
  jmp alltraps
80106cab:	e9 54 f8 ff ff       	jmp    80106504 <alltraps>
...
80106cb0:	6a 00                	push   $0x0
  pushl $30
80106cb2:	6a 1e                	push   $0x1e
  jmp alltraps
80106cb4:	e9 4b f8 ff ff       	jmp    80106504 <alltraps>
...
80106cb9:	6a 00                	push   $0x0
  pushl $31
80106cbb:	6a 1f                	push   $0x1f
  jmp alltraps
80106cbd:	e9 42 f8 ff ff       	jmp    80106504 <alltraps>
...
80106cc2:	6a 00                	push   $0x0
  pushl $32
80106cc4:	6a 20                	push   $0x20
  jmp alltraps
80106cc6:	e9 39 f8 ff ff       	jmp    80106504 <alltraps>
...
80106ccb:	6a 00                	push   $0x0
  pushl $33
80106ccd:	6a 21                	push   $0x21
  jmp alltraps
80106ccf:	e9 30 f8 ff ff       	jmp    80106504 <alltraps>
...
80106cd4:	6a 00                	push   $0x0
  pushl $34
80106cd6:	6a 22                	push   $0x22
  jmp alltraps
80106cd8:	e9 27 f8 ff ff       	jmp    80106504 <alltraps>
...
80106cdd:	6a 00                	push   $0x0
  pushl $35
80106cdf:	6a 23                	push   $0x23
  jmp alltraps
80106ce1:	e9 1e f8 ff ff       	jmp    80106504 <alltraps>
...
80106ce6:	6a 00                	push   $0x0
  pushl $36
80106ce8:	6a 24                	push   $0x24
  jmp alltraps
80106cea:	e9 15 f8 ff ff       	jmp    80106504 <alltraps>
...
80106cef:	6a 00                	push   $0x0
  pushl $37
80106cf1:	6a 25                	push   $0x25
  jmp alltraps
80106cf3:	e9 0c f8 ff ff       	jmp    80106504 <alltraps>
...
80106cf8:	6a 00                	push   $0x0
  pushl $38
80106cfa:	6a 26                	push   $0x26
  jmp alltraps
80106cfc:	e9 03 f8 ff ff       	jmp    80106504 <alltraps>
...
80106d01:	6a 00                	push   $0x0
  pushl $39
80106d03:	6a 27                	push   $0x27
  jmp alltraps
80106d05:	e9 fa f7 ff ff       	jmp    80106504 <alltraps>
...
80106d0a:	6a 00                	push   $0x0
  pushl $40
80106d0c:	6a 28                	push   $0x28
  jmp alltraps
80106d0e:	e9 f1 f7 ff ff       	jmp    80106504 <alltraps>
...
80106d13:	6a 00                	push   $0x0
  pushl $41
80106d15:	6a 29                	push   $0x29
  jmp alltraps
80106d17:	e9 e8 f7 ff ff       	jmp    80106504 <alltraps>
...
80106d1c:	6a 00                	push   $0x0
  pushl $42
80106d1e:	6a 2a                	push   $0x2a
  jmp alltraps
80106d20:	e9 df f7 ff ff       	jmp    80106504 <alltraps>
...
80106d25:	6a 00                	push   $0x0
  pushl $43
80106d27:	6a 2b                	push   $0x2b
  jmp alltraps
80106d29:	e9 d6 f7 ff ff       	jmp    80106504 <alltraps>
...
80106d2e:	6a 00                	push   $0x0
  pushl $44
80106d30:	6a 2c                	push   $0x2c
  jmp alltraps
80106d32:	e9 cd f7 ff ff       	jmp    80106504 <alltraps>
...
80106d37:	6a 00                	push   $0x0
  pushl $45
80106d39:	6a 2d                	push   $0x2d
  jmp alltraps
80106d3b:	e9 c4 f7 ff ff       	jmp    80106504 <alltraps>
...
80106d40:	6a 00                	push   $0x0
  pushl $46
80106d42:	6a 2e                	push   $0x2e
  jmp alltraps
80106d44:	e9 bb f7 ff ff       	jmp    80106504 <alltraps>
...
80106d49:	6a 00                	push   $0x0
  pushl $47
80106d4b:	6a 2f                	push   $0x2f
  jmp alltraps
80106d4d:	e9 b2 f7 ff ff       	jmp    80106504 <alltraps>
...
80106d52:	6a 00                	push   $0x0
  pushl $48
80106d54:	6a 30                	push   $0x30
  jmp alltraps
80106d56:	e9 a9 f7 ff ff       	jmp    80106504 <alltraps>
...
80106d5b:	6a 00                	push   $0x0
  pushl $49
80106d5d:	6a 31                	push   $0x31
  jmp alltraps
80106d5f:	e9 a0 f7 ff ff       	jmp    80106504 <alltraps>
...
80106d64:	6a 00                	push   $0x0
  pushl $50
80106d66:	6a 32                	push   $0x32
  jmp alltraps
80106d68:	e9 97 f7 ff ff       	jmp    80106504 <alltraps>
...
80106d6d:	6a 00                	push   $0x0
  pushl $51
80106d6f:	6a 33                	push   $0x33
  jmp alltraps
80106d71:	e9 8e f7 ff ff       	jmp    80106504 <alltraps>
...
80106d76:	6a 00                	push   $0x0
  pushl $52
80106d78:	6a 34                	push   $0x34
  jmp alltraps
80106d7a:	e9 85 f7 ff ff       	jmp    80106504 <alltraps>
...
80106d7f:	6a 00                	push   $0x0
  pushl $53
80106d81:	6a 35                	push   $0x35
  jmp alltraps
80106d83:	e9 7c f7 ff ff       	jmp    80106504 <alltraps>
...
80106d88:	6a 00                	push   $0x0
  pushl $54
80106d8a:	6a 36                	push   $0x36
  jmp alltraps
80106d8c:	e9 73 f7 ff ff       	jmp    80106504 <alltraps>
...
80106d91:	6a 00                	push   $0x0
  pushl $55
80106d93:	6a 37                	push   $0x37
  jmp alltraps
80106d95:	e9 6a f7 ff ff       	jmp    80106504 <alltraps>
...
80106d9a:	6a 00                	push   $0x0
  pushl $56
80106d9c:	6a 38                	push   $0x38
  jmp alltraps
80106d9e:	e9 61 f7 ff ff       	jmp    80106504 <alltraps>
...
80106da3:	6a 00                	push   $0x0
  pushl $57
80106da5:	6a 39                	push   $0x39
  jmp alltraps
80106da7:	e9 58 f7 ff ff       	jmp    80106504 <alltraps>
...
80106dac:	6a 00                	push   $0x0
  pushl $58
80106dae:	6a 3a                	push   $0x3a
  jmp alltraps
80106db0:	e9 4f f7 ff ff       	jmp    80106504 <alltraps>
...
80106db5:	6a 00                	push   $0x0
  pushl $59
80106db7:	6a 3b                	push   $0x3b
  jmp alltraps
80106db9:	e9 46 f7 ff ff       	jmp    80106504 <alltraps>
...
80106dbe:	6a 00                	push   $0x0
  pushl $60
80106dc0:	6a 3c                	push   $0x3c
  jmp alltraps
80106dc2:	e9 3d f7 ff ff       	jmp    80106504 <alltraps>
...
80106dc7:	6a 00                	push   $0x0
  pushl $61
80106dc9:	6a 3d                	push   $0x3d
  jmp alltraps
80106dcb:	e9 34 f7 ff ff       	jmp    80106504 <alltraps>
...
80106dd0:	6a 00                	push   $0x0
  pushl $62
80106dd2:	6a 3e                	push   $0x3e
  jmp alltraps
80106dd4:	e9 2b f7 ff ff       	jmp    80106504 <alltraps>
...
80106dd9:	6a 00                	push   $0x0
  pushl $63
80106ddb:	6a 3f                	push   $0x3f
  jmp alltraps
80106ddd:	e9 22 f7 ff ff       	jmp    80106504 <alltraps>
...
80106de2:	6a 00                	push   $0x0
  pushl $64
80106de4:	6a 40                	push   $0x40
  jmp alltraps
80106de6:	e9 19 f7 ff ff       	jmp    80106504 <alltraps>
...
80106deb:	6a 00                	push   $0x0
  pushl $65
80106ded:	6a 41                	push   $0x41
  jmp alltraps
80106def:	e9 10 f7 ff ff       	jmp    80106504 <alltraps>
...
80106df4:	6a 00                	push   $0x0
  pushl $66
80106df6:	6a 42                	push   $0x42
  jmp alltraps
80106df8:	e9 07 f7 ff ff       	jmp    80106504 <alltraps>
...
80106dfd:	6a 00                	push   $0x0
  pushl $67
80106dff:	6a 43                	push   $0x43
  jmp alltraps
80106e01:	e9 fe f6 ff ff       	jmp    80106504 <alltraps>
...
80106e06:	6a 00                	push   $0x0
  pushl $68
80106e08:	6a 44                	push   $0x44
  jmp alltraps
80106e0a:	e9 f5 f6 ff ff       	jmp    80106504 <alltraps>
...
80106e0f:	6a 00                	push   $0x0
  pushl $69
80106e11:	6a 45                	push   $0x45
  jmp alltraps
80106e13:	e9 ec f6 ff ff       	jmp    80106504 <alltraps>
...
80106e18:	6a 00                	push   $0x0
  pushl $70
80106e1a:	6a 46                	push   $0x46
  jmp alltraps
80106e1c:	e9 e3 f6 ff ff       	jmp    80106504 <alltraps>
...
80106e21:	6a 00                	push   $0x0
  pushl $71
80106e23:	6a 47                	push   $0x47
  jmp alltraps
80106e25:	e9 da f6 ff ff       	jmp    80106504 <alltraps>
...
80106e2a:	6a 00                	push   $0x0
  pushl $72
80106e2c:	6a 48                	push   $0x48
  jmp alltraps
80106e2e:	e9 d1 f6 ff ff       	jmp    80106504 <alltraps>
...
80106e33:	6a 00                	push   $0x0
  pushl $73
80106e35:	6a 49                	push   $0x49
  jmp alltraps
80106e37:	e9 c8 f6 ff ff       	jmp    80106504 <alltraps>
...
80106e3c:	6a 00                	push   $0x0
  pushl $74
80106e3e:	6a 4a                	push   $0x4a
  jmp alltraps
80106e40:	e9 bf f6 ff ff       	jmp    80106504 <alltraps>
...
80106e45:	6a 00                	push   $0x0
  pushl $75
80106e47:	6a 4b                	push   $0x4b
  jmp alltraps
80106e49:	e9 b6 f6 ff ff       	jmp    80106504 <alltraps>
...
80106e4e:	6a 00                	push   $0x0
  pushl $76
80106e50:	6a 4c                	push   $0x4c
  jmp alltraps
80106e52:	e9 ad f6 ff ff       	jmp    80106504 <alltraps>
...
80106e57:	6a 00                	push   $0x0
  pushl $77
80106e59:	6a 4d                	push   $0x4d
  jmp alltraps
80106e5b:	e9 a4 f6 ff ff       	jmp    80106504 <alltraps>
...
80106e60:	6a 00                	push   $0x0
  pushl $78
80106e62:	6a 4e                	push   $0x4e
  jmp alltraps
80106e64:	e9 9b f6 ff ff       	jmp    80106504 <alltraps>
...
80106e69:	6a 00                	push   $0x0
  pushl $79
80106e6b:	6a 4f                	push   $0x4f
  jmp alltraps
80106e6d:	e9 92 f6 ff ff       	jmp    80106504 <alltraps>
...
80106e72:	6a 00                	push   $0x0
  pushl $80
80106e74:	6a 50                	push   $0x50
  jmp alltraps
80106e76:	e9 89 f6 ff ff       	jmp    80106504 <alltraps>
...
80106e7b:	6a 00                	push   $0x0
  pushl $81
80106e7d:	6a 51                	push   $0x51
  jmp alltraps
80106e7f:	e9 80 f6 ff ff       	jmp    80106504 <alltraps>
...
80106e84:	6a 00                	push   $0x0
  pushl $82
80106e86:	6a 52                	push   $0x52
  jmp alltraps
80106e88:	e9 77 f6 ff ff       	jmp    80106504 <alltraps>
...
80106e8d:	6a 00                	push   $0x0
  pushl $83
80106e8f:	6a 53                	push   $0x53
  jmp alltraps
80106e91:	e9 6e f6 ff ff       	jmp    80106504 <alltraps>
...
80106e96:	6a 00                	push   $0x0
  pushl $84
80106e98:	6a 54                	push   $0x54
  jmp alltraps
80106e9a:	e9 65 f6 ff ff       	jmp    80106504 <alltraps>
...
80106e9f:	6a 00                	push   $0x0
  pushl $85
80106ea1:	6a 55                	push   $0x55
  jmp alltraps
80106ea3:	e9 5c f6 ff ff       	jmp    80106504 <alltraps>
...
80106ea8:	6a 00                	push   $0x0
  pushl $86
80106eaa:	6a 56                	push   $0x56
  jmp alltraps
80106eac:	e9 53 f6 ff ff       	jmp    80106504 <alltraps>
...
80106eb1:	6a 00                	push   $0x0
  pushl $87
80106eb3:	6a 57                	push   $0x57
  jmp alltraps
80106eb5:	e9 4a f6 ff ff       	jmp    80106504 <alltraps>
...
80106eba:	6a 00                	push   $0x0
  pushl $88
80106ebc:	6a 58                	push   $0x58
  jmp alltraps
80106ebe:	e9 41 f6 ff ff       	jmp    80106504 <alltraps>
...
80106ec3:	6a 00                	push   $0x0
  pushl $89
80106ec5:	6a 59                	push   $0x59
  jmp alltraps
80106ec7:	e9 38 f6 ff ff       	jmp    80106504 <alltraps>
...
80106ecc:	6a 00                	push   $0x0
  pushl $90
80106ece:	6a 5a                	push   $0x5a
  jmp alltraps
80106ed0:	e9 2f f6 ff ff       	jmp    80106504 <alltraps>
...
80106ed5:	6a 00                	push   $0x0
  pushl $91
80106ed7:	6a 5b                	push   $0x5b
  jmp alltraps
80106ed9:	e9 26 f6 ff ff       	jmp    80106504 <alltraps>
...
80106ede:	6a 00                	push   $0x0
  pushl $92
80106ee0:	6a 5c                	push   $0x5c
  jmp alltraps
80106ee2:	e9 1d f6 ff ff       	jmp    80106504 <alltraps>
...
80106ee7:	6a 00                	push   $0x0
  pushl $93
80106ee9:	6a 5d                	push   $0x5d
  jmp alltraps
80106eeb:	e9 14 f6 ff ff       	jmp    80106504 <alltraps>
...
80106ef0:	6a 00                	push   $0x0
  pushl $94
80106ef2:	6a 5e                	push   $0x5e
  jmp alltraps
80106ef4:	e9 0b f6 ff ff       	jmp    80106504 <alltraps>
...
80106ef9:	6a 00                	push   $0x0
  pushl $95
80106efb:	6a 5f                	push   $0x5f
  jmp alltraps
80106efd:	e9 02 f6 ff ff       	jmp    80106504 <alltraps>
...
80106f02:	6a 00                	push   $0x0
  pushl $96
80106f04:	6a 60                	push   $0x60
  jmp alltraps
80106f06:	e9 f9 f5 ff ff       	jmp    80106504 <alltraps>
...
80106f0b:	6a 00                	push   $0x0
  pushl $97
80106f0d:	6a 61                	push   $0x61
  jmp alltraps
80106f0f:	e9 f0 f5 ff ff       	jmp    80106504 <alltraps>
...
80106f14:	6a 00                	push   $0x0
  pushl $98
80106f16:	6a 62                	push   $0x62
  jmp alltraps
80106f18:	e9 e7 f5 ff ff       	jmp    80106504 <alltraps>
...
80106f1d:	6a 00                	push   $0x0
  pushl $99
80106f1f:	6a 63                	push   $0x63
  jmp alltraps
80106f21:	e9 de f5 ff ff       	jmp    80106504 <alltraps>
...
80106f26:	6a 00                	push   $0x0
  pushl $100
80106f28:	6a 64                	push   $0x64
  jmp alltraps
80106f2a:	e9 d5 f5 ff ff       	jmp    80106504 <alltraps>
...
80106f2f:	6a 00                	push   $0x0
  pushl $101
80106f31:	6a 65                	push   $0x65
  jmp alltraps
80106f33:	e9 cc f5 ff ff       	jmp    80106504 <alltraps>
...
80106f38:	6a 00                	push   $0x0
  pushl $102
80106f3a:	6a 66                	push   $0x66
  jmp alltraps
80106f3c:	e9 c3 f5 ff ff       	jmp    80106504 <alltraps>
...
80106f41:	6a 00                	push   $0x0
  pushl $103
80106f43:	6a 67                	push   $0x67
  jmp alltraps
80106f45:	e9 ba f5 ff ff       	jmp    80106504 <alltraps>
...
80106f4a:	6a 00                	push   $0x0
  pushl $104
80106f4c:	6a 68                	push   $0x68
  jmp alltraps
80106f4e:	e9 b1 f5 ff ff       	jmp    80106504 <alltraps>
...
80106f53:	6a 00                	push   $0x0
  pushl $105
80106f55:	6a 69                	push   $0x69
  jmp alltraps
80106f57:	e9 a8 f5 ff ff       	jmp    80106504 <alltraps>
...
80106f5c:	6a 00                	push   $0x0
  pushl $106
80106f5e:	6a 6a                	push   $0x6a
  jmp alltraps
80106f60:	e9 9f f5 ff ff       	jmp    80106504 <alltraps>
...
80106f65:	6a 00                	push   $0x0
  pushl $107
80106f67:	6a 6b                	push   $0x6b
  jmp alltraps
80106f69:	e9 96 f5 ff ff       	jmp    80106504 <alltraps>
...
80106f6e:	6a 00                	push   $0x0
  pushl $108
80106f70:	6a 6c                	push   $0x6c
  jmp alltraps
80106f72:	e9 8d f5 ff ff       	jmp    80106504 <alltraps>
...
80106f77:	6a 00                	push   $0x0
  pushl $109
80106f79:	6a 6d                	push   $0x6d
  jmp alltraps
80106f7b:	e9 84 f5 ff ff       	jmp    80106504 <alltraps>
...
80106f80:	6a 00                	push   $0x0
  pushl $110
80106f82:	6a 6e                	push   $0x6e
  jmp alltraps
80106f84:	e9 7b f5 ff ff       	jmp    80106504 <alltraps>
...
80106f89:	6a 00                	push   $0x0
  pushl $111
80106f8b:	6a 6f                	push   $0x6f
  jmp alltraps
80106f8d:	e9 72 f5 ff ff       	jmp    80106504 <alltraps>
...
80106f92:	6a 00                	push   $0x0
  pushl $112
80106f94:	6a 70                	push   $0x70
  jmp alltraps
80106f96:	e9 69 f5 ff ff       	jmp    80106504 <alltraps>
...
80106f9b:	6a 00                	push   $0x0
  pushl $113
80106f9d:	6a 71                	push   $0x71
  jmp alltraps
80106f9f:	e9 60 f5 ff ff       	jmp    80106504 <alltraps>
...
80106fa4:	6a 00                	push   $0x0
  pushl $114
80106fa6:	6a 72                	push   $0x72
  jmp alltraps
80106fa8:	e9 57 f5 ff ff       	jmp    80106504 <alltraps>
...
80106fad:	6a 00                	push   $0x0
  pushl $115
80106faf:	6a 73                	push   $0x73
  jmp alltraps
80106fb1:	e9 4e f5 ff ff       	jmp    80106504 <alltraps>
...
80106fb6:	6a 00                	push   $0x0
  pushl $116
80106fb8:	6a 74                	push   $0x74
  jmp alltraps
80106fba:	e9 45 f5 ff ff       	jmp    80106504 <alltraps>
...
80106fbf:	6a 00                	push   $0x0
  pushl $117
80106fc1:	6a 75                	push   $0x75
  jmp alltraps
80106fc3:	e9 3c f5 ff ff       	jmp    80106504 <alltraps>
...
80106fc8:	6a 00                	push   $0x0
  pushl $118
80106fca:	6a 76                	push   $0x76
  jmp alltraps
80106fcc:	e9 33 f5 ff ff       	jmp    80106504 <alltraps>
...
80106fd1:	6a 00                	push   $0x0
  pushl $119
80106fd3:	6a 77                	push   $0x77
  jmp alltraps
80106fd5:	e9 2a f5 ff ff       	jmp    80106504 <alltraps>
...
80106fda:	6a 00                	push   $0x0
  pushl $120
80106fdc:	6a 78                	push   $0x78
  jmp alltraps
80106fde:	e9 21 f5 ff ff       	jmp    80106504 <alltraps>
...
80106fe3:	6a 00                	push   $0x0
  pushl $121
80106fe5:	6a 79                	push   $0x79
  jmp alltraps
80106fe7:	e9 18 f5 ff ff       	jmp    80106504 <alltraps>
...
80106fec:	6a 00                	push   $0x0
  pushl $122
80106fee:	6a 7a                	push   $0x7a
  jmp alltraps
80106ff0:	e9 0f f5 ff ff       	jmp    80106504 <alltraps>
...
80106ff5:	6a 00                	push   $0x0
  pushl $123
80106ff7:	6a 7b                	push   $0x7b
  jmp alltraps
80106ff9:	e9 06 f5 ff ff       	jmp    80106504 <alltraps>
...
80106ffe:	6a 00                	push   $0x0
  pushl $124
80107000:	6a 7c                	push   $0x7c
  jmp alltraps
80107002:	e9 fd f4 ff ff       	jmp    80106504 <alltraps>
...
80107007:	6a 00                	push   $0x0
  pushl $125
80107009:	6a 7d                	push   $0x7d
  jmp alltraps
8010700b:	e9 f4 f4 ff ff       	jmp    80106504 <alltraps>
...
80107010:	6a 00                	push   $0x0
  pushl $126
80107012:	6a 7e                	push   $0x7e
  jmp alltraps
80107014:	e9 eb f4 ff ff       	jmp    80106504 <alltraps>
...
80107019:	6a 00                	push   $0x0
  pushl $127
8010701b:	6a 7f                	push   $0x7f
  jmp alltraps
8010701d:	e9 e2 f4 ff ff       	jmp    80106504 <alltraps>
...
80107022:	6a 00                	push   $0x0
  pushl $128
80107024:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107029:	e9 d6 f4 ff ff       	jmp    80106504 <alltraps>
...
8010702e:	6a 00                	push   $0x0
  pushl $129
80107030:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107035:	e9 ca f4 ff ff       	jmp    80106504 <alltraps>
...
8010703a:	6a 00                	push   $0x0
  pushl $130
8010703c:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107041:	e9 be f4 ff ff       	jmp    80106504 <alltraps>
...
80107046:	6a 00                	push   $0x0
  pushl $131
80107048:	68 83 00 00 00       	push   $0x83
  jmp alltraps
8010704d:	e9 b2 f4 ff ff       	jmp    80106504 <alltraps>
...
80107052:	6a 00                	push   $0x0
  pushl $132
80107054:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107059:	e9 a6 f4 ff ff       	jmp    80106504 <alltraps>
...
8010705e:	6a 00                	push   $0x0
  pushl $133
80107060:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107065:	e9 9a f4 ff ff       	jmp    80106504 <alltraps>
...
8010706a:	6a 00                	push   $0x0
  pushl $134
8010706c:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107071:	e9 8e f4 ff ff       	jmp    80106504 <alltraps>
...
80107076:	6a 00                	push   $0x0
  pushl $135
80107078:	68 87 00 00 00       	push   $0x87
  jmp alltraps
8010707d:	e9 82 f4 ff ff       	jmp    80106504 <alltraps>
...
80107082:	6a 00                	push   $0x0
  pushl $136
80107084:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107089:	e9 76 f4 ff ff       	jmp    80106504 <alltraps>
...
8010708e:	6a 00                	push   $0x0
  pushl $137
80107090:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107095:	e9 6a f4 ff ff       	jmp    80106504 <alltraps>
...
8010709a:	6a 00                	push   $0x0
  pushl $138
8010709c:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801070a1:	e9 5e f4 ff ff       	jmp    80106504 <alltraps>
...
801070a6:	6a 00                	push   $0x0
  pushl $139
801070a8:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801070ad:	e9 52 f4 ff ff       	jmp    80106504 <alltraps>
...
801070b2:	6a 00                	push   $0x0
  pushl $140
801070b4:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801070b9:	e9 46 f4 ff ff       	jmp    80106504 <alltraps>
...
801070be:	6a 00                	push   $0x0
  pushl $141
801070c0:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801070c5:	e9 3a f4 ff ff       	jmp    80106504 <alltraps>
...
801070ca:	6a 00                	push   $0x0
  pushl $142
801070cc:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801070d1:	e9 2e f4 ff ff       	jmp    80106504 <alltraps>
...
801070d6:	6a 00                	push   $0x0
  pushl $143
801070d8:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801070dd:	e9 22 f4 ff ff       	jmp    80106504 <alltraps>
...
801070e2:	6a 00                	push   $0x0
  pushl $144
801070e4:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801070e9:	e9 16 f4 ff ff       	jmp    80106504 <alltraps>
...
801070ee:	6a 00                	push   $0x0
  pushl $145
801070f0:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801070f5:	e9 0a f4 ff ff       	jmp    80106504 <alltraps>
...
801070fa:	6a 00                	push   $0x0
  pushl $146
801070fc:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107101:	e9 fe f3 ff ff       	jmp    80106504 <alltraps>
...
80107106:	6a 00                	push   $0x0
  pushl $147
80107108:	68 93 00 00 00       	push   $0x93
  jmp alltraps
8010710d:	e9 f2 f3 ff ff       	jmp    80106504 <alltraps>
...
80107112:	6a 00                	push   $0x0
  pushl $148
80107114:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107119:	e9 e6 f3 ff ff       	jmp    80106504 <alltraps>
...
8010711e:	6a 00                	push   $0x0
  pushl $149
80107120:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107125:	e9 da f3 ff ff       	jmp    80106504 <alltraps>
...
8010712a:	6a 00                	push   $0x0
  pushl $150
8010712c:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107131:	e9 ce f3 ff ff       	jmp    80106504 <alltraps>
...
80107136:	6a 00                	push   $0x0
  pushl $151
80107138:	68 97 00 00 00       	push   $0x97
  jmp alltraps
8010713d:	e9 c2 f3 ff ff       	jmp    80106504 <alltraps>
...
80107142:	6a 00                	push   $0x0
  pushl $152
80107144:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107149:	e9 b6 f3 ff ff       	jmp    80106504 <alltraps>
...
8010714e:	6a 00                	push   $0x0
  pushl $153
80107150:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107155:	e9 aa f3 ff ff       	jmp    80106504 <alltraps>
...
8010715a:	6a 00                	push   $0x0
  pushl $154
8010715c:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107161:	e9 9e f3 ff ff       	jmp    80106504 <alltraps>
...
80107166:	6a 00                	push   $0x0
  pushl $155
80107168:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010716d:	e9 92 f3 ff ff       	jmp    80106504 <alltraps>
...
80107172:	6a 00                	push   $0x0
  pushl $156
80107174:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107179:	e9 86 f3 ff ff       	jmp    80106504 <alltraps>
...
8010717e:	6a 00                	push   $0x0
  pushl $157
80107180:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107185:	e9 7a f3 ff ff       	jmp    80106504 <alltraps>
...
8010718a:	6a 00                	push   $0x0
  pushl $158
8010718c:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107191:	e9 6e f3 ff ff       	jmp    80106504 <alltraps>
...
80107196:	6a 00                	push   $0x0
  pushl $159
80107198:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
8010719d:	e9 62 f3 ff ff       	jmp    80106504 <alltraps>
...
801071a2:	6a 00                	push   $0x0
  pushl $160
801071a4:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801071a9:	e9 56 f3 ff ff       	jmp    80106504 <alltraps>
...
801071ae:	6a 00                	push   $0x0
  pushl $161
801071b0:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801071b5:	e9 4a f3 ff ff       	jmp    80106504 <alltraps>
...
801071ba:	6a 00                	push   $0x0
  pushl $162
801071bc:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801071c1:	e9 3e f3 ff ff       	jmp    80106504 <alltraps>
...
801071c6:	6a 00                	push   $0x0
  pushl $163
801071c8:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801071cd:	e9 32 f3 ff ff       	jmp    80106504 <alltraps>
...
801071d2:	6a 00                	push   $0x0
  pushl $164
801071d4:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801071d9:	e9 26 f3 ff ff       	jmp    80106504 <alltraps>
...
801071de:	6a 00                	push   $0x0
  pushl $165
801071e0:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801071e5:	e9 1a f3 ff ff       	jmp    80106504 <alltraps>
...
801071ea:	6a 00                	push   $0x0
  pushl $166
801071ec:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801071f1:	e9 0e f3 ff ff       	jmp    80106504 <alltraps>
...
801071f6:	6a 00                	push   $0x0
  pushl $167
801071f8:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801071fd:	e9 02 f3 ff ff       	jmp    80106504 <alltraps>
...
80107202:	6a 00                	push   $0x0
  pushl $168
80107204:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107209:	e9 f6 f2 ff ff       	jmp    80106504 <alltraps>
...
8010720e:	6a 00                	push   $0x0
  pushl $169
80107210:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107215:	e9 ea f2 ff ff       	jmp    80106504 <alltraps>
...
8010721a:	6a 00                	push   $0x0
  pushl $170
8010721c:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107221:	e9 de f2 ff ff       	jmp    80106504 <alltraps>
...
80107226:	6a 00                	push   $0x0
  pushl $171
80107228:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
8010722d:	e9 d2 f2 ff ff       	jmp    80106504 <alltraps>
...
80107232:	6a 00                	push   $0x0
  pushl $172
80107234:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107239:	e9 c6 f2 ff ff       	jmp    80106504 <alltraps>
...
8010723e:	6a 00                	push   $0x0
  pushl $173
80107240:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107245:	e9 ba f2 ff ff       	jmp    80106504 <alltraps>
...
8010724a:	6a 00                	push   $0x0
  pushl $174
8010724c:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107251:	e9 ae f2 ff ff       	jmp    80106504 <alltraps>
...
80107256:	6a 00                	push   $0x0
  pushl $175
80107258:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
8010725d:	e9 a2 f2 ff ff       	jmp    80106504 <alltraps>
...
80107262:	6a 00                	push   $0x0
  pushl $176
80107264:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107269:	e9 96 f2 ff ff       	jmp    80106504 <alltraps>
...
8010726e:	6a 00                	push   $0x0
  pushl $177
80107270:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107275:	e9 8a f2 ff ff       	jmp    80106504 <alltraps>
...
8010727a:	6a 00                	push   $0x0
  pushl $178
8010727c:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107281:	e9 7e f2 ff ff       	jmp    80106504 <alltraps>
...
80107286:	6a 00                	push   $0x0
  pushl $179
80107288:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
8010728d:	e9 72 f2 ff ff       	jmp    80106504 <alltraps>
...
80107292:	6a 00                	push   $0x0
  pushl $180
80107294:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107299:	e9 66 f2 ff ff       	jmp    80106504 <alltraps>
...
8010729e:	6a 00                	push   $0x0
  pushl $181
801072a0:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801072a5:	e9 5a f2 ff ff       	jmp    80106504 <alltraps>
...
801072aa:	6a 00                	push   $0x0
  pushl $182
801072ac:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801072b1:	e9 4e f2 ff ff       	jmp    80106504 <alltraps>
...
801072b6:	6a 00                	push   $0x0
  pushl $183
801072b8:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801072bd:	e9 42 f2 ff ff       	jmp    80106504 <alltraps>
...
801072c2:	6a 00                	push   $0x0
  pushl $184
801072c4:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801072c9:	e9 36 f2 ff ff       	jmp    80106504 <alltraps>
...
801072ce:	6a 00                	push   $0x0
  pushl $185
801072d0:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801072d5:	e9 2a f2 ff ff       	jmp    80106504 <alltraps>
...
801072da:	6a 00                	push   $0x0
  pushl $186
801072dc:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801072e1:	e9 1e f2 ff ff       	jmp    80106504 <alltraps>
...
801072e6:	6a 00                	push   $0x0
  pushl $187
801072e8:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801072ed:	e9 12 f2 ff ff       	jmp    80106504 <alltraps>
...
801072f2:	6a 00                	push   $0x0
  pushl $188
801072f4:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801072f9:	e9 06 f2 ff ff       	jmp    80106504 <alltraps>
...
801072fe:	6a 00                	push   $0x0
  pushl $189
80107300:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107305:	e9 fa f1 ff ff       	jmp    80106504 <alltraps>
...
8010730a:	6a 00                	push   $0x0
  pushl $190
8010730c:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107311:	e9 ee f1 ff ff       	jmp    80106504 <alltraps>
...
80107316:	6a 00                	push   $0x0
  pushl $191
80107318:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
8010731d:	e9 e2 f1 ff ff       	jmp    80106504 <alltraps>
...
80107322:	6a 00                	push   $0x0
  pushl $192
80107324:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107329:	e9 d6 f1 ff ff       	jmp    80106504 <alltraps>
...
8010732e:	6a 00                	push   $0x0
  pushl $193
80107330:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107335:	e9 ca f1 ff ff       	jmp    80106504 <alltraps>
...
8010733a:	6a 00                	push   $0x0
  pushl $194
8010733c:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107341:	e9 be f1 ff ff       	jmp    80106504 <alltraps>
...
80107346:	6a 00                	push   $0x0
  pushl $195
80107348:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
8010734d:	e9 b2 f1 ff ff       	jmp    80106504 <alltraps>
...
80107352:	6a 00                	push   $0x0
  pushl $196
80107354:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107359:	e9 a6 f1 ff ff       	jmp    80106504 <alltraps>
...
8010735e:	6a 00                	push   $0x0
  pushl $197
80107360:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107365:	e9 9a f1 ff ff       	jmp    80106504 <alltraps>
...
8010736a:	6a 00                	push   $0x0
  pushl $198
8010736c:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107371:	e9 8e f1 ff ff       	jmp    80106504 <alltraps>
...
80107376:	6a 00                	push   $0x0
  pushl $199
80107378:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
8010737d:	e9 82 f1 ff ff       	jmp    80106504 <alltraps>
...
80107382:	6a 00                	push   $0x0
  pushl $200
80107384:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107389:	e9 76 f1 ff ff       	jmp    80106504 <alltraps>
...
8010738e:	6a 00                	push   $0x0
  pushl $201
80107390:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107395:	e9 6a f1 ff ff       	jmp    80106504 <alltraps>
...
8010739a:	6a 00                	push   $0x0
  pushl $202
8010739c:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801073a1:	e9 5e f1 ff ff       	jmp    80106504 <alltraps>
...
801073a6:	6a 00                	push   $0x0
  pushl $203
801073a8:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801073ad:	e9 52 f1 ff ff       	jmp    80106504 <alltraps>
...
801073b2:	6a 00                	push   $0x0
  pushl $204
801073b4:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801073b9:	e9 46 f1 ff ff       	jmp    80106504 <alltraps>
...
801073be:	6a 00                	push   $0x0
  pushl $205
801073c0:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801073c5:	e9 3a f1 ff ff       	jmp    80106504 <alltraps>
...
801073ca:	6a 00                	push   $0x0
  pushl $206
801073cc:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801073d1:	e9 2e f1 ff ff       	jmp    80106504 <alltraps>
...
801073d6:	6a 00                	push   $0x0
  pushl $207
801073d8:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801073dd:	e9 22 f1 ff ff       	jmp    80106504 <alltraps>
...
801073e2:	6a 00                	push   $0x0
  pushl $208
801073e4:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801073e9:	e9 16 f1 ff ff       	jmp    80106504 <alltraps>
...
801073ee:	6a 00                	push   $0x0
  pushl $209
801073f0:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801073f5:	e9 0a f1 ff ff       	jmp    80106504 <alltraps>
...
801073fa:	6a 00                	push   $0x0
  pushl $210
801073fc:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107401:	e9 fe f0 ff ff       	jmp    80106504 <alltraps>
...
80107406:	6a 00                	push   $0x0
  pushl $211
80107408:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
8010740d:	e9 f2 f0 ff ff       	jmp    80106504 <alltraps>
...
80107412:	6a 00                	push   $0x0
  pushl $212
80107414:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107419:	e9 e6 f0 ff ff       	jmp    80106504 <alltraps>
...
8010741e:	6a 00                	push   $0x0
  pushl $213
80107420:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107425:	e9 da f0 ff ff       	jmp    80106504 <alltraps>
...
8010742a:	6a 00                	push   $0x0
  pushl $214
8010742c:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107431:	e9 ce f0 ff ff       	jmp    80106504 <alltraps>
...
80107436:	6a 00                	push   $0x0
  pushl $215
80107438:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
8010743d:	e9 c2 f0 ff ff       	jmp    80106504 <alltraps>
...
80107442:	6a 00                	push   $0x0
  pushl $216
80107444:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107449:	e9 b6 f0 ff ff       	jmp    80106504 <alltraps>
...
8010744e:	6a 00                	push   $0x0
  pushl $217
80107450:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107455:	e9 aa f0 ff ff       	jmp    80106504 <alltraps>
...
8010745a:	6a 00                	push   $0x0
  pushl $218
8010745c:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107461:	e9 9e f0 ff ff       	jmp    80106504 <alltraps>
...
80107466:	6a 00                	push   $0x0
  pushl $219
80107468:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
8010746d:	e9 92 f0 ff ff       	jmp    80106504 <alltraps>
...
80107472:	6a 00                	push   $0x0
  pushl $220
80107474:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107479:	e9 86 f0 ff ff       	jmp    80106504 <alltraps>
...
8010747e:	6a 00                	push   $0x0
  pushl $221
80107480:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107485:	e9 7a f0 ff ff       	jmp    80106504 <alltraps>
...
8010748a:	6a 00                	push   $0x0
  pushl $222
8010748c:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107491:	e9 6e f0 ff ff       	jmp    80106504 <alltraps>
...
80107496:	6a 00                	push   $0x0
  pushl $223
80107498:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
8010749d:	e9 62 f0 ff ff       	jmp    80106504 <alltraps>
...
801074a2:	6a 00                	push   $0x0
  pushl $224
801074a4:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801074a9:	e9 56 f0 ff ff       	jmp    80106504 <alltraps>
...
801074ae:	6a 00                	push   $0x0
  pushl $225
801074b0:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801074b5:	e9 4a f0 ff ff       	jmp    80106504 <alltraps>
...
801074ba:	6a 00                	push   $0x0
  pushl $226
801074bc:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801074c1:	e9 3e f0 ff ff       	jmp    80106504 <alltraps>
...
801074c6:	6a 00                	push   $0x0
  pushl $227
801074c8:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801074cd:	e9 32 f0 ff ff       	jmp    80106504 <alltraps>
...
801074d2:	6a 00                	push   $0x0
  pushl $228
801074d4:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801074d9:	e9 26 f0 ff ff       	jmp    80106504 <alltraps>
...
801074de:	6a 00                	push   $0x0
  pushl $229
801074e0:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801074e5:	e9 1a f0 ff ff       	jmp    80106504 <alltraps>
...
801074ea:	6a 00                	push   $0x0
  pushl $230
801074ec:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801074f1:	e9 0e f0 ff ff       	jmp    80106504 <alltraps>
...
801074f6:	6a 00                	push   $0x0
  pushl $231
801074f8:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801074fd:	e9 02 f0 ff ff       	jmp    80106504 <alltraps>
...
80107502:	6a 00                	push   $0x0
  pushl $232
80107504:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107509:	e9 f6 ef ff ff       	jmp    80106504 <alltraps>
...
8010750e:	6a 00                	push   $0x0
  pushl $233
80107510:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107515:	e9 ea ef ff ff       	jmp    80106504 <alltraps>
...
8010751a:	6a 00                	push   $0x0
  pushl $234
8010751c:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107521:	e9 de ef ff ff       	jmp    80106504 <alltraps>
...
80107526:	6a 00                	push   $0x0
  pushl $235
80107528:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
8010752d:	e9 d2 ef ff ff       	jmp    80106504 <alltraps>
...
80107532:	6a 00                	push   $0x0
  pushl $236
80107534:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107539:	e9 c6 ef ff ff       	jmp    80106504 <alltraps>
...
8010753e:	6a 00                	push   $0x0
  pushl $237
80107540:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107545:	e9 ba ef ff ff       	jmp    80106504 <alltraps>
...
8010754a:	6a 00                	push   $0x0
  pushl $238
8010754c:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107551:	e9 ae ef ff ff       	jmp    80106504 <alltraps>
...
80107556:	6a 00                	push   $0x0
  pushl $239
80107558:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
8010755d:	e9 a2 ef ff ff       	jmp    80106504 <alltraps>
...
80107562:	6a 00                	push   $0x0
  pushl $240
80107564:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107569:	e9 96 ef ff ff       	jmp    80106504 <alltraps>
...
8010756e:	6a 00                	push   $0x0
  pushl $241
80107570:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107575:	e9 8a ef ff ff       	jmp    80106504 <alltraps>
...
8010757a:	6a 00                	push   $0x0
  pushl $242
8010757c:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107581:	e9 7e ef ff ff       	jmp    80106504 <alltraps>
...
80107586:	6a 00                	push   $0x0
  pushl $243
80107588:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
8010758d:	e9 72 ef ff ff       	jmp    80106504 <alltraps>
...
80107592:	6a 00                	push   $0x0
  pushl $244
80107594:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107599:	e9 66 ef ff ff       	jmp    80106504 <alltraps>
...
8010759e:	6a 00                	push   $0x0
  pushl $245
801075a0:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801075a5:	e9 5a ef ff ff       	jmp    80106504 <alltraps>
...
801075aa:	6a 00                	push   $0x0
  pushl $246
801075ac:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801075b1:	e9 4e ef ff ff       	jmp    80106504 <alltraps>
...
801075b6:	6a 00                	push   $0x0
  pushl $247
801075b8:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801075bd:	e9 42 ef ff ff       	jmp    80106504 <alltraps>
...
801075c2:	6a 00                	push   $0x0
  pushl $248
801075c4:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801075c9:	e9 36 ef ff ff       	jmp    80106504 <alltraps>
...
801075ce:	6a 00                	push   $0x0
  pushl $249
801075d0:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801075d5:	e9 2a ef ff ff       	jmp    80106504 <alltraps>
...
801075da:	6a 00                	push   $0x0
  pushl $250
801075dc:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801075e1:	e9 1e ef ff ff       	jmp    80106504 <alltraps>
...
801075e6:	6a 00                	push   $0x0
  pushl $251
801075e8:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801075ed:	e9 12 ef ff ff       	jmp    80106504 <alltraps>
...
801075f2:	6a 00                	push   $0x0
  pushl $252
801075f4:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801075f9:	e9 06 ef ff ff       	jmp    80106504 <alltraps>
...
801075fe:	6a 00                	push   $0x0
  pushl $253
80107600:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107605:	e9 fa ee ff ff       	jmp    80106504 <alltraps>
...
8010760a:	6a 00                	push   $0x0
  pushl $254
8010760c:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107611:	e9 ee ee ff ff       	jmp    80106504 <alltraps>
...
80107616:	6a 00                	push   $0x0
  pushl $255
80107618:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
8010761d:	e9 e2 ee ff ff       	jmp    80106504 <alltraps>
	...
...
80107627:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
8010762a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010762d:	83 e8 01             	sub    $0x1,%eax
80107630:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107634:	8b 45 08             	mov    0x8(%ebp),%eax
80107637:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010763b:	8b 45 08             	mov    0x8(%ebp),%eax
8010763e:	c1 e8 10             	shr    $0x10,%eax
80107641:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107645:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107648:	0f 01 10             	lgdtl  (%eax)
}
8010764b:	c9                   	leave  
8010764c:	c3                   	ret    
...
80107656:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
8010765a:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
8010765e:	0f 00 d8             	ltr    %ax
}
80107661:	c9                   	leave  
80107662:	c3                   	ret    
...
8010766c:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107670:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107674:	8e e8                	mov    %eax,%gs
}
80107676:	c9                   	leave  
80107677:	c3                   	ret    
...
80107696:	05 00 00 00 80       	add    $0x80000000,%eax
8010769b:	5d                   	pop    %ebp
8010769c:	c3                   	ret    
...
801076a1:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
801076a4:	e8 1a b8 ff ff       	call   80102ec3 <cpunum>
801076a9:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801076af:	05 60 23 11 80       	add    $0x80112360,%eax
801076b4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801076b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076ba:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
801076c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076c3:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
801076c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076cc:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
801076d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076d3:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801076d7:	83 e2 f0             	and    $0xfffffff0,%edx
801076da:	83 ca 0a             	or     $0xa,%edx
...
80107731:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107735:	83 ca 40             	or     $0x40,%edx
80107738:	88 50 7e             	mov    %dl,0x7e(%eax)
...
8010774b:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010774f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107752:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107759:	ff ff 
8010775b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010775e:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107765:	00 00 
80107767:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010776a:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107771:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107774:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010777b:	83 e2 f0             	and    $0xfffffff0,%edx
8010777e:	83 ca 02             	or     $0x2,%edx
80107781:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107787:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010778a:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107791:	83 ca 10             	or     $0x10,%edx
80107794:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010779a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010779d:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801077a4:	83 e2 9f             	and    $0xffffff9f,%edx
801077a7:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801077ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077b0:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801077b7:	83 ca 80             	or     $0xffffff80,%edx
801077ba:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801077c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077c3:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801077ca:	83 ca 0f             	or     $0xf,%edx
801077cd:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801077d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077d6:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801077dd:	83 e2 ef             	and    $0xffffffef,%edx
801077e0:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801077e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077e9:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801077f0:	83 e2 df             	and    $0xffffffdf,%edx
801077f3:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801077f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077fc:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107803:	83 ca 40             	or     $0x40,%edx
80107806:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010780c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010780f:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107816:	83 ca 80             	or     $0xffffff80,%edx
80107819:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010781f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107822:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
...
80107906:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
8010790d:	ff ff 
8010790f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107912:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107919:	00 00 
8010791b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010791e:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80107925:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107928:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010792f:	83 e2 f0             	and    $0xfffffff0,%edx
80107932:	83 ca 02             	or     $0x2,%edx
80107935:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
8010793b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010793e:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107945:	83 ca 10             	or     $0x10,%edx
80107948:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
8010794e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107951:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107958:	83 ca 60             	or     $0x60,%edx
8010795b:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107961:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107964:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010796b:	83 ca 80             	or     $0xffffff80,%edx
8010796e:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107974:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107977:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010797e:	83 ca 0f             	or     $0xf,%edx
80107981:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107987:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010798a:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107991:	83 e2 ef             	and    $0xffffffef,%edx
80107994:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010799a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010799d:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801079a4:	83 e2 df             	and    $0xffffffdf,%edx
801079a7:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801079ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079b0:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801079b7:	83 ca 40             	or     $0x40,%edx
801079ba:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801079c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c3:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801079ca:	83 ca 80             	or     $0xffffff80,%edx
801079cd:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801079d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079d6:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801079dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079e0:	05 b4 00 00 00       	add    $0xb4,%eax
801079e5:	89 c3                	mov    %eax,%ebx
801079e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079ea:	05 b4 00 00 00       	add    $0xb4,%eax
801079ef:	c1 e8 10             	shr    $0x10,%eax
801079f2:	89 c1                	mov    %eax,%ecx
801079f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079f7:	05 b4 00 00 00       	add    $0xb4,%eax
801079fc:	c1 e8 18             	shr    $0x18,%eax
801079ff:	89 c2                	mov    %eax,%edx
80107a01:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a04:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107a0b:	00 00 
80107a0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a10:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107a17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a1a:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107a20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a23:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107a2a:	83 e1 f0             	and    $0xfffffff0,%ecx
80107a2d:	83 c9 02             	or     $0x2,%ecx
80107a30:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107a36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a39:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107a40:	83 c9 10             	or     $0x10,%ecx
80107a43:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107a49:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a4c:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107a53:	83 e1 9f             	and    $0xffffff9f,%ecx
80107a56:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107a5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a5f:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107a66:	83 c9 80             	or     $0xffffff80,%ecx
80107a69:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107a6f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a72:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107a79:	83 e1 f0             	and    $0xfffffff0,%ecx
80107a7c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107a82:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a85:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107a8c:	83 e1 ef             	and    $0xffffffef,%ecx
80107a8f:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107a95:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a98:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107a9f:	83 e1 df             	and    $0xffffffdf,%ecx
80107aa2:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107aa8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aab:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107ab2:	83 c9 40             	or     $0x40,%ecx
80107ab5:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107abb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107abe:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107ac5:	83 c9 80             	or     $0xffffff80,%ecx
80107ac8:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107ace:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ad1:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107ad7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ada:	83 c0 70             	add    $0x70,%eax
80107add:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107ae4:	00 
80107ae5:	89 04 24             	mov    %eax,(%esp)
80107ae8:	e8 37 fb ff ff       	call   80107624 <lgdt>
  loadgs(SEG_KCPU << 3);
80107aed:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107af4:	e8 6a fb ff ff       	call   80107663 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107af9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107afc:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107b02:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107b09:	00 00 00 00 
}
80107b0d:	83 c4 24             	add    $0x24,%esp
80107b10:	5b                   	pop    %ebx
80107b11:	5d                   	pop    %ebp
80107b12:	c3                   	ret    
...
80107b1c:	c1 e8 16             	shr    $0x16,%eax
80107b1f:	c1 e0 02             	shl    $0x2,%eax
80107b22:	03 45 08             	add    0x8(%ebp),%eax
80107b25:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107b28:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b2b:	8b 00                	mov    (%eax),%eax
80107b2d:	83 e0 01             	and    $0x1,%eax
80107b30:	84 c0                	test   %al,%al
80107b32:	74 17                	je     80107b4b <walkpgdir+0x38>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80107b34:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b37:	8b 00                	mov    (%eax),%eax
80107b39:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107b3e:	89 04 24             	mov    %eax,(%esp)
80107b41:	e8 4a fb ff ff       	call   80107690 <p2v>
80107b46:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107b49:	eb 4b                	jmp    80107b96 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107b4b:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107b4f:	74 0e                	je     80107b5f <walkpgdir+0x4c>
80107b51:	e8 b5 af ff ff       	call   80102b0b <kalloc>
80107b56:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107b59:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107b5d:	75 07                	jne    80107b66 <walkpgdir+0x53>
      return 0;
80107b5f:	b8 00 00 00 00       	mov    $0x0,%eax
80107b64:	eb 41                	jmp    80107ba7 <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107b66:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107b6d:	00 
80107b6e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107b75:	00 
80107b76:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b79:	89 04 24             	mov    %eax,(%esp)
80107b7c:	e8 61 d5 ff ff       	call   801050e2 <memset>
...
80107b87:	e8 f7 fa ff ff       	call   80107683 <v2p>
80107b8c:	89 c2                	mov    %eax,%edx
80107b8e:	83 ca 07             	or     $0x7,%edx
80107b91:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b94:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107b96:	8b 45 0c             	mov    0xc(%ebp),%eax
80107b99:	c1 e8 0c             	shr    $0xc,%eax
80107b9c:	25 ff 03 00 00       	and    $0x3ff,%eax
80107ba1:	c1 e0 02             	shl    $0x2,%eax
80107ba4:	03 45 f4             	add    -0xc(%ebp),%eax
}
80107ba7:	c9                   	leave  
80107ba8:	c3                   	ret    
...
80107bac:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
  
  a = (char*)PGROUNDDOWN((uint)va);
80107baf:	8b 45 0c             	mov    0xc(%ebp),%eax
80107bb2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107bb7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107bba:	8b 45 0c             	mov    0xc(%ebp),%eax
80107bbd:	03 45 10             	add    0x10(%ebp),%eax
80107bc0:	83 e8 01             	sub    $0x1,%eax
80107bc3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107bc8:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107bcb:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107bd2:	00 
80107bd3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bd6:	89 44 24 04          	mov    %eax,0x4(%esp)
80107bda:	8b 45 08             	mov    0x8(%ebp),%eax
80107bdd:	89 04 24             	mov    %eax,(%esp)
80107be0:	e8 2e ff ff ff       	call   80107b13 <walkpgdir>
80107be5:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107be8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107bec:	75 07                	jne    80107bf5 <mappages+0x4c>
      return -1;
80107bee:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107bf3:	eb 46                	jmp    80107c3b <mappages+0x92>
    if(*pte & PTE_P)
80107bf5:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107bf8:	8b 00                	mov    (%eax),%eax
80107bfa:	83 e0 01             	and    $0x1,%eax
80107bfd:	84 c0                	test   %al,%al
80107bff:	74 0c                	je     80107c0d <mappages+0x64>
      panic("remap");
80107c01:	c7 04 24 34 8a 10 80 	movl   $0x80108a34,(%esp)
80107c08:	e8 30 89 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
80107c0d:	8b 45 18             	mov    0x18(%ebp),%eax
80107c10:	0b 45 14             	or     0x14(%ebp),%eax
80107c13:	89 c2                	mov    %eax,%edx
80107c15:	83 ca 01             	or     $0x1,%edx
...
80107c23:	74 10                	je     80107c35 <mappages+0x8c>
      break;
    a += PGSIZE;
...
80107c33:	eb 96                	jmp    80107bcb <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80107c41:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107c44:	e8 c2 ae ff ff       	call   80102b0b <kalloc>
80107c49:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107c4c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107c50:	75 0a                	jne    80107c5c <setupkvm+0x1f>
    return 0;
80107c52:	b8 00 00 00 00       	mov    $0x0,%eax
80107c57:	e9 98 00 00 00       	jmp    80107cf4 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107c5c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107c63:	00 
80107c64:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107c6b:	00 
80107c6c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c6f:	89 04 24             	mov    %eax,(%esp)
80107c72:	e8 6b d4 ff ff       	call   801050e2 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107c77:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107c7e:	e8 0d fa ff ff       	call   80107690 <p2v>
80107c83:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107c88:	76 0c                	jbe    80107c96 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107c8a:	c7 04 24 3a 8a 10 80 	movl   $0x80108a3a,(%esp)
80107c91:	e8 a7 88 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107c96:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107c9d:	eb 49                	jmp    80107ce8 <setupkvm+0xab>
...
80107c9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107ca2:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80107ca5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107ca8:	8b 50 04             	mov    0x4(%eax),%edx
80107cab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cae:	8b 58 08             	mov    0x8(%eax),%ebx
80107cb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cb4:	8b 40 04             	mov    0x4(%eax),%eax
80107cb7:	29 c3                	sub    %eax,%ebx
80107cb9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cbc:	8b 00                	mov    (%eax),%eax
80107cbe:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107cc2:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107cc6:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107cca:	89 44 24 04          	mov    %eax,0x4(%esp)
80107cce:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107cd1:	89 04 24             	mov    %eax,(%esp)
80107cd4:	e8 d0 fe ff ff       	call   80107ba9 <mappages>
80107cd9:	85 c0                	test   %eax,%eax
80107cdb:	79 07                	jns    80107ce4 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107cdd:	b8 00 00 00 00       	mov    $0x0,%eax
80107ce2:	eb 10                	jmp    80107cf4 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107ce4:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107ce8:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107cef:	72 ae                	jb     80107c9f <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107cf4:	83 c4 34             	add    $0x34,%esp
80107cf7:	5b                   	pop    %ebx
80107cf8:	5d                   	pop    %ebp
80107cf9:	c3                   	ret    
...
80107cfd:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107d00:	e8 38 ff ff ff       	call   80107c3d <setupkvm>
80107d05:	a3 38 52 11 80       	mov    %eax,0x80115238
  switchkvm();
80107d0a:	e8 02 00 00 00       	call   80107d11 <switchkvm>
}
80107d0f:	c9                   	leave  
80107d10:	c3                   	ret    
...
80107d17:	a1 38 52 11 80       	mov    0x80115238,%eax
80107d1c:	89 04 24             	mov    %eax,(%esp)
80107d1f:	e8 5f f9 ff ff       	call   80107683 <v2p>
80107d24:	89 04 24             	mov    %eax,(%esp)
80107d27:	e8 4c f9 ff ff       	call   80107678 <lcr3>
}
80107d2c:	c9                   	leave  
80107d2d:	c3                   	ret    
...
80107d32:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107d35:	e8 a1 d2 ff ff       	call   80104fdb <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107d3a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d40:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107d47:	83 c2 08             	add    $0x8,%edx
80107d4a:	89 d3                	mov    %edx,%ebx
80107d4c:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107d53:	83 c2 08             	add    $0x8,%edx
80107d56:	c1 ea 10             	shr    $0x10,%edx
80107d59:	89 d1                	mov    %edx,%ecx
80107d5b:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107d62:	83 c2 08             	add    $0x8,%edx
80107d65:	c1 ea 18             	shr    $0x18,%edx
80107d68:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107d6f:	67 00 
80107d71:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107d78:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107d7e:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107d85:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d88:	83 c9 09             	or     $0x9,%ecx
80107d8b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107d91:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107d98:	83 c9 10             	or     $0x10,%ecx
80107d9b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107da1:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107da8:	83 e1 9f             	and    $0xffffff9f,%ecx
80107dab:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107db1:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107db8:	83 c9 80             	or     $0xffffff80,%ecx
80107dbb:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107dc1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107dc8:	83 e1 f0             	and    $0xfffffff0,%ecx
80107dcb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107dd1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107dd8:	83 e1 ef             	and    $0xffffffef,%ecx
80107ddb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107de1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107de8:	83 e1 df             	and    $0xffffffdf,%ecx
80107deb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107df1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107df8:	83 c9 40             	or     $0x40,%ecx
80107dfb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107e01:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107e08:	83 e1 7f             	and    $0x7f,%ecx
80107e0b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107e11:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107e17:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107e1d:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80107e24:	83 e2 ef             	and    $0xffffffef,%edx
80107e27:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107e2d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107e33:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107e39:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107e3f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107e46:	8b 52 08             	mov    0x8(%edx),%edx
80107e49:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107e4f:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107e52:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107e59:	e8 ef f7 ff ff       	call   8010764d <ltr>
  if(p->pgdir == 0)
80107e5e:	8b 45 08             	mov    0x8(%ebp),%eax
80107e61:	8b 40 04             	mov    0x4(%eax),%eax
80107e64:	85 c0                	test   %eax,%eax
80107e66:	75 0c                	jne    80107e74 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107e68:	c7 04 24 4b 8a 10 80 	movl   $0x80108a4b,(%esp)
80107e6f:	e8 c9 86 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107e74:	8b 45 08             	mov    0x8(%ebp),%eax
80107e77:	8b 40 04             	mov    0x4(%eax),%eax
80107e7a:	89 04 24             	mov    %eax,(%esp)
80107e7d:	e8 01 f8 ff ff       	call   80107683 <v2p>
80107e82:	89 04 24             	mov    %eax,(%esp)
80107e85:	e8 ee f7 ff ff       	call   80107678 <lcr3>
  popcli();
80107e8a:	e8 94 d1 ff ff       	call   80105023 <popcli>
}
80107e8f:	83 c4 14             	add    $0x14,%esp
80107e92:	5b                   	pop    %ebx
80107e93:	5d                   	pop    %ebp
80107e94:	c3                   	ret    
...
80107e98:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107e9b:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107ea2:	76 0c                	jbe    80107eb0 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107ea4:	c7 04 24 5f 8a 10 80 	movl   $0x80108a5f,(%esp)
80107eab:	e8 8d 86 ff ff       	call   8010053d <panic>
  mem = kalloc();
80107eb0:	e8 56 ac ff ff       	call   80102b0b <kalloc>
80107eb5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80107eb8:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107ebf:	00 
80107ec0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107ec7:	00 
80107ec8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ecb:	89 04 24             	mov    %eax,(%esp)
80107ece:	e8 0f d2 ff ff       	call   801050e2 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107ed3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ed6:	89 04 24             	mov    %eax,(%esp)
80107ed9:	e8 a5 f7 ff ff       	call   80107683 <v2p>
80107ede:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107ee5:	00 
80107ee6:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
80107f00:	e8 a4 fc ff ff       	call   80107ba9 <mappages>
  memmove(mem, init, sz);
80107f05:	8b 45 10             	mov    0x10(%ebp),%eax
80107f08:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107f19:	e8 97 d2 ff ff       	call   801051b5 <memmove>
}
80107f1e:	c9                   	leave  
80107f1f:	c3                   	ret    
...
80107f24:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107f27:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f2a:	25 ff 0f 00 00       	and    $0xfff,%eax
80107f2f:	85 c0                	test   %eax,%eax
80107f31:	74 0c                	je     80107f3f <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80107f33:	c7 04 24 7c 8a 10 80 	movl   $0x80108a7c,(%esp)
80107f3a:	e8 fe 85 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107f3f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107f46:	e9 ad 00 00 00       	jmp    80107ff8 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107f4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f4e:	8b 55 0c             	mov    0xc(%ebp),%edx
80107f51:	01 d0                	add    %edx,%eax
80107f53:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107f5a:	00 
80107f5b:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f5f:	8b 45 08             	mov    0x8(%ebp),%eax
80107f62:	89 04 24             	mov    %eax,(%esp)
80107f65:	e8 a9 fb ff ff       	call   80107b13 <walkpgdir>
80107f6a:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107f6d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107f71:	75 0c                	jne    80107f7f <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80107f73:	c7 04 24 9f 8a 10 80 	movl   $0x80108a9f,(%esp)
80107f7a:	e8 be 85 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
80107f7f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107f82:	8b 00                	mov    (%eax),%eax
80107f84:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107f89:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80107f8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f8f:	8b 55 18             	mov    0x18(%ebp),%edx
80107f92:	89 d1                	mov    %edx,%ecx
80107f94:	29 c1                	sub    %eax,%ecx
80107f96:	89 c8                	mov    %ecx,%eax
80107f98:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107f9d:	77 11                	ja     80107fb0 <loaduvm+0x90>
      n = sz - i;
80107f9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa2:	8b 55 18             	mov    0x18(%ebp),%edx
80107fa5:	89 d1                	mov    %edx,%ecx
80107fa7:	29 c1                	sub    %eax,%ecx
80107fa9:	89 c8                	mov    %ecx,%eax
80107fab:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107fae:	eb 07                	jmp    80107fb7 <loaduvm+0x97>
    else
      n = PGSIZE;
80107fb0:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80107fb7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fba:	8b 55 14             	mov    0x14(%ebp),%edx
80107fbd:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80107fc0:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107fc3:	89 04 24             	mov    %eax,(%esp)
80107fc6:	e8 c5 f6 ff ff       	call   80107690 <p2v>
80107fcb:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107fce:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107fd2:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107fd6:	89 44 24 04          	mov    %eax,0x4(%esp)
80107fda:	8b 45 10             	mov    0x10(%ebp),%eax
80107fdd:	89 04 24             	mov    %eax,(%esp)
80107fe0:	e8 85 9d ff ff       	call   80101d6a <readi>
80107fe5:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107fe8:	74 07                	je     80107ff1 <loaduvm+0xd1>
      return -1;
80107fea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107fef:	eb 18                	jmp    80108009 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80107ff1:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107ff8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ffb:	3b 45 18             	cmp    0x18(%ebp),%eax
80107ffe:	0f 82 47 ff ff ff    	jb     80107f4b <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80108009:	83 c4 24             	add    $0x24,%esp
8010800c:	5b                   	pop    %ebx
8010800d:	5d                   	pop    %ebp
8010800e:	c3                   	ret    
...
80108012:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80108021:	e9 c1 00 00 00       	jmp    801080e7 <allocuvm+0xd8>
  if(newsz < oldsz)
...
80108031:	e9 b1 00 00 00       	jmp    801080e7 <allocuvm+0xd8>
...
80108046:	e9 8d 00 00 00       	jmp    801080d8 <allocuvm+0xc9>
    mem = kalloc();
8010804b:	e8 bb aa ff ff       	call   80102b0b <kalloc>
80108050:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108053:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108057:	75 2c                	jne    80108085 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108059:	c7 04 24 bd 8a 10 80 	movl   $0x80108abd,(%esp)
80108060:	e8 3c 83 ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108065:	8b 45 0c             	mov    0xc(%ebp),%eax
80108068:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108079:	e8 6b 00 00 00       	call   801080e9 <deallocuvm>
      return 0;
8010807e:	b8 00 00 00 00       	mov    $0x0,%eax
80108083:	eb 62                	jmp    801080e7 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108085:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010808c:	00 
8010808d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108094:	00 
80108095:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108098:	89 04 24             	mov    %eax,(%esp)
8010809b:	e8 42 d0 ff ff       	call   801050e2 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801080a0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080a3:	89 04 24             	mov    %eax,(%esp)
801080a6:	e8 d8 f5 ff ff       	call   80107683 <v2p>
801080ab:	8b 55 f4             	mov    -0xc(%ebp),%edx
801080ae:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801080b5:	00 
801080b6:	89 44 24 0c          	mov    %eax,0xc(%esp)
801080ba:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801080c1:	00 
801080c2:	89 54 24 04          	mov    %edx,0x4(%esp)
801080c6:	8b 45 08             	mov    0x8(%ebp),%eax
801080c9:	89 04 24             	mov    %eax,(%esp)
801080cc:	e8 d8 fa ff ff       	call   80107ba9 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
801080d1:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801080d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080db:	3b 45 10             	cmp    0x10(%ebp),%eax
801080de:	0f 82 67 ff ff ff    	jb     8010804b <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
801080ec:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
801080ef:	8b 45 10             	mov    0x10(%ebp),%eax
801080f2:	3b 45 0c             	cmp    0xc(%ebp),%eax
801080f5:	72 08                	jb     801080ff <deallocuvm+0x16>
    return oldsz;
801080f7:	8b 45 0c             	mov    0xc(%ebp),%eax
801080fa:	e9 a4 00 00 00       	jmp    801081a3 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
801080ff:	8b 45 10             	mov    0x10(%ebp),%eax
80108102:	05 ff 0f 00 00       	add    $0xfff,%eax
80108107:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010810c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010810f:	e9 80 00 00 00       	jmp    80108194 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108114:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108117:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010811e:	00 
8010811f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108123:	8b 45 08             	mov    0x8(%ebp),%eax
80108126:	89 04 24             	mov    %eax,(%esp)
80108129:	e8 e5 f9 ff ff       	call   80107b13 <walkpgdir>
8010812e:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108131:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108135:	75 09                	jne    80108140 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80108137:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
8010813e:	eb 4d                	jmp    8010818d <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108140:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108143:	8b 00                	mov    (%eax),%eax
80108145:	83 e0 01             	and    $0x1,%eax
80108148:	84 c0                	test   %al,%al
8010814a:	74 41                	je     8010818d <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
8010814c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010814f:	8b 00                	mov    (%eax),%eax
80108151:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108156:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108159:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010815d:	75 0c                	jne    8010816b <deallocuvm+0x82>
        panic("kfree");
8010815f:	c7 04 24 d5 8a 10 80 	movl   $0x80108ad5,(%esp)
80108166:	e8 d2 83 ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
8010816b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010816e:	89 04 24             	mov    %eax,(%esp)
80108171:	e8 1a f5 ff ff       	call   80107690 <p2v>
80108176:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108179:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010817c:	89 04 24             	mov    %eax,(%esp)
8010817f:	e8 ee a8 ff ff       	call   80102a72 <kfree>
      *pte = 0;
80108184:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108187:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
8010819a:	0f 82 74 ff ff ff    	jb     80108114 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
801081a8:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
801081ab:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801081af:	75 0c                	jne    801081bd <freevm+0x18>
    panic("freevm: no pgdir");
801081b1:	c7 04 24 db 8a 10 80 	movl   $0x80108adb,(%esp)
801081b8:	e8 80 83 ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
801081bd:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801081c4:	00 
801081c5:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801081cc:	80 
801081cd:	8b 45 08             	mov    0x8(%ebp),%eax
801081d0:	89 04 24             	mov    %eax,(%esp)
801081d3:	e8 11 ff ff ff       	call   801080e9 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801081d8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801081df:	eb 3c                	jmp    8010821d <freevm+0x78>
    if(pgdir[i] & PTE_P){
801081e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081e4:	c1 e0 02             	shl    $0x2,%eax
801081e7:	03 45 08             	add    0x8(%ebp),%eax
801081ea:	8b 00                	mov    (%eax),%eax
801081ec:	83 e0 01             	and    $0x1,%eax
801081ef:	84 c0                	test   %al,%al
801081f1:	74 26                	je     80108219 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
801081f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081f6:	c1 e0 02             	shl    $0x2,%eax
801081f9:	03 45 08             	add    0x8(%ebp),%eax
801081fc:	8b 00                	mov    (%eax),%eax
801081fe:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108203:	89 04 24             	mov    %eax,(%esp)
80108206:	e8 85 f4 ff ff       	call   80107690 <p2v>
8010820b:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
8010820e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108211:	89 04 24             	mov    %eax,(%esp)
80108214:	e8 59 a8 ff ff       	call   80102a72 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108219:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010821d:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108224:	76 bb                	jbe    801081e1 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
8010822c:	e8 41 a8 ff ff       	call   80102a72 <kfree>
}
80108231:	c9                   	leave  
80108232:	c3                   	ret    
...
80108239:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108240:	00 
...
8010824e:	e8 c0 f8 ff ff       	call   80107b13 <walkpgdir>
80108253:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108256:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010825a:	75 0c                	jne    80108268 <clearpteu+0x35>
    panic("clearpteu");
8010825c:	c7 04 24 ec 8a 10 80 	movl   $0x80108aec,(%esp)
...
8010826f:	83 e2 fb             	and    $0xfffffffb,%edx
...
8010827d:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108280:	e8 b8 f9 ff ff       	call   80107c3d <setupkvm>
80108285:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108288:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010828c:	75 0a                	jne    80108298 <copyuvm+0x1f>
    return 0;
8010828e:	b8 00 00 00 00       	mov    $0x0,%eax
80108293:	e9 fd 00 00 00       	jmp    80108395 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108298:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010829f:	e9 cc 00 00 00       	jmp    80108370 <copyuvm+0xf7>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801082a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082a7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801082ae:	00 
801082af:	89 44 24 04          	mov    %eax,0x4(%esp)
801082b3:	8b 45 08             	mov    0x8(%ebp),%eax
801082b6:	89 04 24             	mov    %eax,(%esp)
801082b9:	e8 55 f8 ff ff       	call   80107b13 <walkpgdir>
801082be:	89 45 ec             	mov    %eax,-0x14(%ebp)
801082c1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801082c5:	75 0c                	jne    801082d3 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
801082c7:	c7 04 24 f6 8a 10 80 	movl   $0x80108af6,(%esp)
801082ce:	e8 6a 82 ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
801082d3:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082d6:	8b 00                	mov    (%eax),%eax
801082d8:	83 e0 01             	and    $0x1,%eax
801082db:	85 c0                	test   %eax,%eax
801082dd:	75 0c                	jne    801082eb <copyuvm+0x72>
      panic("copyuvm: page not present");
801082df:	c7 04 24 10 8b 10 80 	movl   $0x80108b10,(%esp)
801082e6:	e8 52 82 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
801082eb:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082ee:	8b 00                	mov    (%eax),%eax
801082f0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801082f5:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
801082f8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082fb:	8b 00                	mov    (%eax),%eax
801082fd:	25 ff 0f 00 00       	and    $0xfff,%eax
80108302:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108305:	e8 01 a8 ff ff       	call   80102b0b <kalloc>
8010830a:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010830d:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108311:	74 6e                	je     80108381 <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108313:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108316:	89 04 24             	mov    %eax,(%esp)
80108319:	e8 72 f3 ff ff       	call   80107690 <p2v>
...
80108360:	e8 44 f8 ff ff       	call   80107ba9 <mappages>
80108365:	85 c0                	test   %eax,%eax
80108367:	78 1b                	js     80108384 <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108369:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108370:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108373:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108376:	0f 82 28 ff ff ff    	jb     801082a4 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
8010837f:	eb 14                	jmp    80108395 <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108381:	90                   	nop
80108382:	eb 01                	jmp    80108385 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
80108384:	90                   	nop
...
8010838b:	e8 15 fe ff ff       	call   801081a5 <freevm>
  return 0;
80108390:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108395:	83 c4 44             	add    $0x44,%esp
80108398:	5b                   	pop    %ebx
80108399:	5d                   	pop    %ebp
8010839a:	c3                   	ret    
...
8010839e:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
801083ac:	89 44 24 04          	mov    %eax,0x4(%esp)
801083b0:	8b 45 08             	mov    0x8(%ebp),%eax
801083b3:	89 04 24             	mov    %eax,(%esp)
801083b6:	e8 58 f7 ff ff       	call   80107b13 <walkpgdir>
801083bb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
801083be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083c1:	8b 00                	mov    (%eax),%eax
801083c3:	83 e0 01             	and    $0x1,%eax
801083c6:	85 c0                	test   %eax,%eax
801083c8:	75 07                	jne    801083d1 <uva2ka+0x36>
    return 0;
801083ca:	b8 00 00 00 00       	mov    $0x0,%eax
801083cf:	eb 25                	jmp    801083f6 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
801083d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083d4:	8b 00                	mov    (%eax),%eax
801083d6:	83 e0 04             	and    $0x4,%eax
801083d9:	85 c0                	test   %eax,%eax
801083db:	75 07                	jne    801083e4 <uva2ka+0x49>
    return 0;
801083dd:	b8 00 00 00 00       	mov    $0x0,%eax
801083e2:	eb 12                	jmp    801083f6 <uva2ka+0x5b>
...
801083f1:	e8 9a f2 ff ff       	call   80107690 <p2v>
}
801083f6:	c9                   	leave  
801083f7:	c3                   	ret    
...
80108401:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108404:	e9 8b 00 00 00       	jmp    80108494 <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
80108409:	8b 45 0c             	mov    0xc(%ebp),%eax
8010840c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108411:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108414:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108417:	89 44 24 04          	mov    %eax,0x4(%esp)
8010841b:	8b 45 08             	mov    0x8(%ebp),%eax
8010841e:	89 04 24             	mov    %eax,(%esp)
80108421:	e8 75 ff ff ff       	call   8010839b <uva2ka>
80108426:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108429:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
8010842d:	75 07                	jne    80108436 <copyout+0x3e>
      return -1;
8010842f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108434:	eb 6d                	jmp    801084a3 <copyout+0xab>
    n = PGSIZE - (va - va0);
80108436:	8b 45 0c             	mov    0xc(%ebp),%eax
80108439:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010843c:	89 d1                	mov    %edx,%ecx
8010843e:	29 c1                	sub    %eax,%ecx
80108440:	89 c8                	mov    %ecx,%eax
80108442:	05 00 10 00 00       	add    $0x1000,%eax
80108447:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
8010844a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010844d:	3b 45 14             	cmp    0x14(%ebp),%eax
80108450:	76 06                	jbe    80108458 <copyout+0x60>
      n = len;
80108452:	8b 45 14             	mov    0x14(%ebp),%eax
80108455:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108458:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010845b:	8b 55 0c             	mov    0xc(%ebp),%edx
8010845e:	89 d1                	mov    %edx,%ecx
80108460:	29 c1                	sub    %eax,%ecx
80108462:	89 c8                	mov    %ecx,%eax
80108464:	03 45 e8             	add    -0x18(%ebp),%eax
80108467:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010846a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010846e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108471:	89 54 24 04          	mov    %edx,0x4(%esp)
80108475:	89 04 24             	mov    %eax,(%esp)
80108478:	e8 38 cd ff ff       	call   801051b5 <memmove>
    len -= n;
8010847d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108480:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108483:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108486:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108489:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010848c:	05 00 10 00 00       	add    $0x1000,%eax
80108491:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108494:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108498:	0f 85 6b ff ff ff    	jne    80108409 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
