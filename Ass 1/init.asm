...
main(void)
{
  ...
  b5:	75 48                	jne    ff <main+0xff>
      exec("sh", argv);
  b7:	c7 44 24 04 70 0b 00 	movl   $0xb70,0x4(%esp)
  be:	00 
  bf:	c7 04 24 db 08 00 00 	movl   $0x8db,(%esp)
  c6:	e8 fd 02 00 00       	call   3c8 <exec>
      printf(1, "init: exec sh failed\n");
  cb:	c7 44 24 04 0c 09 00 	movl   $0x90c,0x4(%esp)
  d2:	00 
  ...
  e6:	e8 a5 02 00 00       	call   390 <exit>
    ...
    while((wpid=wait(NULL)) >= 0 && wpid != pid)
      printf(1, "zombie!\n");
  eb:	c7 44 24 04 22 09 00 	movl   $0x922,0x4(%esp)
  f2:	00 
