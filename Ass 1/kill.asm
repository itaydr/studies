...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e2:	0f b6 90 68 0a 00 00 	movzbl 0xa68(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 541:	75 27                	jne    56a <printf+0x11f>
          s = "(null)";
 543:	c7 45 f4 23 08 00 00 	movl   $0x823,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 60f:	a1 84 0a 00 00       	mov    0xa84,%eax
...
free(void *ap)
{
 ...
 6d0:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 6d5:	c9                   	leave  
 6d6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 723:	e8 d8 fe ff ff       	call   600 <free>
  return freep;
 728:	a1 84 0a 00 00       	mov    0xa84,%eax
}
 72d:	c9                   	leave  
 72e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 741:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 744:	a1 84 0a 00 00       	mov    0xa84,%eax
 749:	89 45 f0             	mov    %eax,-0x10(%ebp)
 74c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 750:	75 23                	jne    775 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 752:	c7 45 f0 7c 0a 00 00 	movl   $0xa7c,-0x10(%ebp)
 759:	8b 45 f0             	mov    -0x10(%ebp),%eax
 75c:	a3 84 0a 00 00       	mov    %eax,0xa84
 761:	a1 84 0a 00 00       	mov    0xa84,%eax
 766:	a3 7c 0a 00 00       	mov    %eax,0xa7c
    base.s.size = 0;
 76b:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 772:	00 00 00 
  }
 ...
 7c8:	a3 84 0a 00 00       	mov    %eax,0xa84
      return (void*)(p + 1);
 ...
 7d3:	eb 38                	jmp    80d <malloc+0xde>
    ...
    if(p == freep)
 7d5:	a1 84 0a 00 00       	mov    0xa84,%eax
